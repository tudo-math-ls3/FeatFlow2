...
!</subroutine>
  ...
  call output_line('--------------------------')
  call output_line ('#Vertices = '//trim(sys_si(rproblem%RlevelInfo(rproblem%NLMAX)%rtriangulation%NVT,2)) )
  call output_line('--------------------------')
  call output_line ('#Elements = '//trim(sys_si(rproblem%RlevelInfo(rproblem%NLMAX)%rtriangulation%NEL,2)) )
  call output_line('--------------------------')
