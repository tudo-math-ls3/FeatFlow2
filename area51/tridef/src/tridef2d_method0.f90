...
!</subroutine>
    ...
    ! it to rboundary.
    CALL boundary_read_prm(rboundary, './pre/bench2m55.prm')
        
    ! Now read in the basic triangulation.
    CALL tria_readTriFile2D (rtriangulation, './pre/bench2m55.tri', rboundary)
    ...
    CALL griddef_deformationInit(rgriddefInfo,rtriangulation,NLMAX,rboundary,10)                 
