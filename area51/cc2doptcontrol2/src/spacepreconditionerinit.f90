...
!</output>
    ...
    call stlin_getFullMatrixDummy(rproblem%rphysicsPrimal,rnonlinearSpatialMatrix)
...
!</subroutine>
    ...
    case (CCPREC_LINEARSOLVER,CCPREC_NEWTON,CCPREC_INEXACTNEWTON)
      ...
      call mlprj_initPrjHierarchy(rpreconditioner%rprjHierarchy,nlmin,nlmax)
      do i=nlmin,nlmax
        ! Initialise the projection for level i
        call mlprj_initPrjHierarchyLevel(rpreconditioner%rprjHierarchy,i,&
        ...
        if (i .gt. nlmin) then
          call cc_getProlRest (rpreconditioner%rprjHierarchy%p_Rprojection(i-nlmin+1), &
