...
!<subroutine>
  ...
  subroutine coeff_RHS1D_Laplace (rdiscretisation,rform, &
...
!<subroutine>
  ...
  subroutine coeff_RHS1D_Mass (rdiscretisation,rform, &
                  nelements,npointsPerElement,Dpoints, &
                  IdofsTest,rdomainIntSubset,&
                  Dcoefficients,rcollection)
...
!<subroutine>
  ...
  subroutine getReferenceFunction1D (cderivative,rdiscretisation, &
                nelements,npointsPerElement,Dpoints, &
                IdofsTest,rdomainIntSubset,&
                Dvalues,rcollection)
