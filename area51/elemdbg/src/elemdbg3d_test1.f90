...
!</subroutine>
    ...
    do ilvl = NLMIN, NLMAX
      ...
      call spdiscr_initDiscr_simple (rdiscretisation%RspatialDiscr(1), &
          EL_Q1_3D, CUB_G5_3D, rtriangulation)
      ...
      call pperr_scalar (rvecSolM%RvectorBlock(1),PPERR_L2ERROR,&
                         Derror(1,ilvl), getReferenceFunction3D)

      call pperr_scalar (rvecSolM%RvectorBlock(1),PPERR_H1ERROR,&
                         Derror(2,ilvl), getReferenceFunction3D)
      ...
      call pperr_scalar (rvecSolL%RvectorBlock(1),PPERR_L2ERROR,&
                         Derror(3,ilvl), getReferenceFunction3D)

      call pperr_scalar (rvecSolL%RvectorBlock(1),PPERR_H1ERROR,&
                         Derror(4,ilvl), getReferenceFunction3D)
    ...
    call output_line('Level        NEQ        NNZE         NVT         NMT         NAT         NEL')
    do ilvl = NLMIN, NLMAX
