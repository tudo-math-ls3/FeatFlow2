...
!</subroutine>
    ...
    character(LEN=PARLST_MLDATA) :: sbdex3,sbdex4,sbdex5,sbdex6
        ...
        do isegment = 1,parlst_querysubstrings (p_rbdcond, cstr)
          ...
          if (dpar2 .ge. dpar1) then
            ...
            case (1)
              ...
              read(cstr,*) dvalue,iintervalEnds,ibctyp,sbdex1,sbdex2,sbdex3,sbdex4,sbdex5,sbdex6
              ...
              if (sbdex3 .ne. '') then
                ...
                ! X-velocity of the solid skeleton
                !
                ! The 1st element in IquickAccess saves the component number.
              ...
              if (sbdex4 .ne. '') then
                ...
                ! Y-velocity of the solid skeleton
                !
                ! The 1st element in IquickAccess saves the component number.
              ...
              if (sbdex5 .ne. '') then
                ...
                ! X-velocity of the pore fluid
                !
                ! The 1st element in IquickAccess saves the component number.
                rcoll%IquickAccess(2) = 5
                
                ! IquickAccess(3) saves the type of the expression
                iexptyp = collct_getvalue_int (rcoll, sbdex5)
                rcoll%IquickAccess(3) = iexptyp
                
                ! The 1st element in the sting quick access array is
                ! the name of the expression to evaluate.
                rcoll%SquickAccess(1) = sbdex5
                ...
                case (BDC_VALDOUBLE,BDC_VALPARPROFILE)
                  ! Constant or parabolic profile
                  rcoll%Dquickaccess(4) = &
                      collct_getvalue_real (rcoll,sbdex5, 0, SEC_SBDEXPRESSIONS)
                case (BDC_EXPRESSION)
                  ! Expression. Write the identifier for the expression
                  ! as itag into the boundary condition structure.
                  rcoll%IquickAccess(4) = &
                      collct_getvalue_int (rcoll,sbdex5, 0, SEC_SBDEXPRESSIONS)
                end select
              
                ! Assemble the BC`s.
                call bcasm_newDirichletBConRealBD (&
                    rdiscretisation,5,rboundaryRegion,rdynamicLevelInfo%rdiscreteBC,&
                    cc_getBDconditions,rcoll,casmComplexity)
              ...
              if (sbdex6 .ne. '') then
                ...
                ! Y-velocity of the pore fluid
                !
                ! The 1st element in IquickAccess saves the component number.
                rcoll%IquickAccess(2) = 6
                
                ! IquickAccess(3) saves the type of the expression
                iexptyp = collct_getvalue_int (rcoll, sbdex6)
                rcoll%IquickAccess(3) = iexptyp
                
                ! The 1st element in the sting quick access array is
                ! the name of the expression to evaluate.
                rcoll%SquickAccess(1) = sbdex6
                ...
                case (BDC_VALDOUBLE,BDC_VALPARPROFILE)
                  ! Constant or parabolic profile
                  rcoll%Dquickaccess(4) = &
                      collct_getvalue_real (rcoll,sbdex6, 0, SEC_SBDEXPRESSIONS)
                case (BDC_EXPRESSION)
                  ! Expression. Write the identifier for the expression
                  ! as itag into the boundary condition structure.
                  rcoll%IquickAccess(4) = &
                      collct_getvalue_int (rcoll,sbdex6, 0, SEC_SBDEXPRESSIONS)
                end select
              
                ! Assemble the BC`s.
                call bcasm_newDirichletBConRealBD (&
                    rdiscretisation,6,rboundaryRegion,rdynamicLevelInfo%rdiscreteBC,&
                    cc_getBDconditions,rcoll,casmComplexity)
          ...
          if (dpar2 .ge. dpar1) then
            ...
            case (1)
              ...
              if (((icomponent .eq. 0) .and. ((sbdex1 .ne. '') .or. (sbdex2 .ne. '') .or. &
		                              (sbdex3 .ne. '') .or. (sbdex4 .ne. '') .or. &
					      (sbdex5 .ne. '') .or. (sbdex6 .ne. ''))) .or. &
                  ((icomponent .eq. 1) .and. (sbdex1 .ne. '')) .or. &
                  ((icomponent .eq. 2) .and. (sbdex2 .ne. '')) .or. &
                  ((icomponent .eq. 3) .and. (sbdex3 .ne. '')) .or. &
                  ((icomponent .eq. 4) .and. (sbdex4 .ne. '')) .or. &
                  ((icomponent .eq. 5) .and. (sbdex5 .ne. '')) .or. &
                  ((icomponent .eq. 6) .and. (sbdex6 .ne. ''))) then
