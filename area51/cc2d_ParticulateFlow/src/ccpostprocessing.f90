...
!</subroutine>
    ...
    integer :: ioutputUCD,ilevelUCD, j,iin
    integer :: ieltype,ipart,ipolyHandle, ipoints
    ...
    write(rexport%iunit, '(A,2I10)') "POLYGONS", rexport%npolygons, 65
    
    write(rexport%iunit, '(65I10)') 64, iconnect(:)
...
!</subroutine>
    ...
    do ipart=1,p_rparticleCollection%nparticles
      ...
      !----------------------------------------------------------------------------------------         
      if( dCenterY .lt. p_rparticleCollection%p_rParticles(ipart)%drad )then
        p_rparticleCollection%p_rParticles(ipart)%dtransVelY=&
        -1.0_dp * p_rparticleCollection%p_rParticles(ipart)%dtransVelY
        
        p_rparticleCollection%p_rParticles(ipart)%dtransVelX=&
        0.994_dp * p_rparticleCollection%p_rParticles(ipart)%dtransVelY        
        
        p_rgeometryObject%rcoord2D%Dorigin(2)= p_rparticleCollection%p_rParticles(ipart)%drad
