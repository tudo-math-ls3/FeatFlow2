...
!<constantblock description="Variables in expressions">
  ...
  character(LEN=10), dimension(8), parameter :: SEC_EXPRVARIABLES = &
    (/'X    ','Y    ','Z    ','L    ','R    ','S    ','TIME ','V'/)
...
!</subroutine>
  ...
  contains
    ...
    ! hier in reval(8) die Geschwindigkeit des Partikels setzten
    ...
    type(t_collection), optional                  :: rcollection
      ...
      case (BDC_EXPRESSION)
        ...
        Rval(7) = dtime
        ! hier die negative Geschwindigkeit des Partikels
        Rval(8) = -rcollection%Dquickaccess(11)
