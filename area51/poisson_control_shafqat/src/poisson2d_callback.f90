...
!<subroutine>
  ...
  subroutine coeff_RHS_2D1(rdiscretisation,rform, &
                  nelements,npointsPerElement,Dpoints, &
...
! Dcoefficients (1,:,:) = 32.0_DP * &
!                     ( Dpoints(2,:,:)*(1.0_DP-Dpoints(2,:,:)) + &
!                       Dpoints(1,:,:)*(1.0_DP-Dpoints(1,:,:)) )+(1.0_DP/0.01_DP)*&
...
!<subroutine>
  ...
  subroutine coeff_RHS_2D2(rdiscretisation,rform, &
                  nelements,npointsPerElement,Dpoints, &
                  IdofsTest,rdomainIntSubset,&
                  Dcoefficients,rcollection)
...
!    Dvalues(1) = 50.0_DP
!    IF ((dwhere .GE. 1.0_DP) .AND. (dwhere .LE. 2.0_DP)) &
!    Dvalues(1) = 250.0_DP
!    IF ((dwhere .GE. 2.0_DP) .AND. (dwhere .LE. 3.0_DP)) &
!    Dvalues(1) = 200.0_DP
!    IF ((dwhere .GE. 0.0_DP) .AND. (dwhere .LE. 1.0_DP)) &
!    Dvalues(1) = 100.0_DP
...
!<subroutine>
  ...
  subroutine getBoundaryValues_2D_P (Icomponents,rdiscretisation,rboundaryRegion,ielement, &
                                   cinfoNeeded,iwhere,dwhere, Dvalues, rcollection)
