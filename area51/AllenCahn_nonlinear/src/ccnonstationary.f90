...
!    call AC5_postprocessing (rACproblem,rACvector,rACproblem%rtimedependence%iiteration,&
!                                                          rproblem%rtimedependence%dtime)
! or 

    call AC5_postprocessing (rACproblem,rACvector,rACproblem%rtimedependence%iiteration,&
                                                          rACproblem%rtimedependence%dtime)
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	...
	! we treat AC5_postprocessing after 1 time step
...
!           rACproblem, rACvector, rACrhs)
 ...
 !~~~~~ 
!          call AC5_timestep (rACproblem,rACvector,rACrhs)   !~~~~We may need also time step...
!Mcai, we use the following to realize coupling 
        ...
        call output_lbrk ()
         ...
         call AC5_timestep (rACproblem,rACvector,rACrhs, &
...
!~~~~~~~~~~~~~~~~AC problem, postprocessing~~~~~~~~~~~~~~~~~~`~~~~
        ...
        ! Postprocessing. Write out the solution if it was calculated successfully.
!        call AC5_postprocessing (rACproblem,rACvector,rACpostprocessing)
!        call AC5_postprocessing (rACproblem,rACvector,rACproblem%rtimedependence%iiteration,&
!                    rproblem%rtimedependence%dtime)
!or
       call AC5_postprocessing (rACproblem,rACvector,rACproblem%rtimedependence%iiteration,&
