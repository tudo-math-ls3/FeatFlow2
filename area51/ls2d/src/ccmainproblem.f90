...
!</subroutine>
    ...
    type(t_vectorBlock) :: rvector,rrhs,rvecLS,rrhsLS
    ...
    call cc_generateBasicMatrices (p_rproblem,rvecLS)
...
!    else
      ...
      call cc_generateBasicRHS (p_rproblem,rrhs,rvecLS)
      ...
      call cc_solveNonstationary (p_rproblem,rvector,rvecLS,rrhs,rrhsLS,rpostprocessing)
...
!    end if
    ...
    ! Cleanup
    call cc_doneMatVec (p_rproblem,rvector,rrhs,rvecLS,rrhsLS)
