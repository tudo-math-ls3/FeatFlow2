...
!            roby=roby/length
      ...
      !rproblem%DTrqForce(1)=-1.0_dp*rproblem%DTrqForce(1)
...
!</subroutine>
    ...
    dvolume  = (0.125_dp)**2 * SYS_PI
    dmasssl  = 1.25_dp * dvolume 
    ddmasssl = 0.25_dp * dvolume 
    dimomir  = dmasssl*((1.25_dp)**2)/4.0_dp !moment of inertia !    
