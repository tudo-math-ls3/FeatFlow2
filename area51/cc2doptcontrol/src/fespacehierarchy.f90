...
!</subroutine>
    ...
    call mshh_initHierarchy(rfeHierarchy%rmeshHierarchy,&
        rtriangulation,rfeHierarchy%nmaxLevels,rboundary,TR_SHARE_ALL)
...
!</subroutine>
    ...
    ! we are creating here.
    call mshh_initHierarchy(rfeHierarchy%rmeshHierarchy,&
        rdiscretisation%p_rtriangulation,rfeHierarchy%nmaxLevels,&
...
!</subroutine>
    ...
    call mshh_initHierarchyDup (rfeHier1%rmeshHierarchy,rfeHier2%rmeshHierarchy)
