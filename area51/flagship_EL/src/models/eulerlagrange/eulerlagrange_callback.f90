...
!# ****************************************************************************
!#
!# The following eulerlagrange routines are available:
!#
...
!#
!# 7.) eulerlagrange_calcLinearizedFCT
...
module eulerlagrange_callback
  ...
  public :: eulerlagrange_calcLinearizedFCT
...
!<description>
    ...
    !  compressible eulerlagrange/Navier-Stokes equations
!</description>
          ...
          case (DISSIPATION_SCALAR_DSPLIT)
            ...
            case (NDIM2D)
              call gfsys_buildResidual(rproblemLevel&
                  %Rmatrix(coeffMatrix_CX:coeffMatrix_CY),&
                  rproblemLevel%Rafcstab(inviscidAFC), rsolution,&
                  eulerlagrange_calcFluxDSplitScalarDiss2d, dscale, .true., rrhs)
              
            case (NDIM3D)
              call gfsys_buildResidual(rproblemLevel&
                  %Rmatrix(coeffMatrix_CX:coeffMatrix_CZ),&
                  rproblemLevel%Rafcstab(inviscidAFC), rsolution,&
                  eulerlagrange_calcFluxDSplitScalarDiss3d, dscale, .true., rrhs)
            end select
          ...
          case (DISSIPATION_TENSOR_DSPLIT)
            ...
            case (NDIM2D)
              call gfsys_buildResidual(rproblemLevel&
                  %Rmatrix(coeffMatrix_CX:coeffMatrix_CY),&
                  rproblemLevel%Rafcstab(inviscidAFC), rsolution,&
                  eulerlagrange_calcFluxDSplitTensorDiss2d, dscale, .true., rrhs)
              
            case (NDIM3D)
              call gfsys_buildResidual(rproblemLevel&
                  %Rmatrix(coeffMatrix_CX:coeffMatrix_CZ),&
                  rproblemLevel%Rafcstab(inviscidAFC), rsolution,&
                  eulerlagrange_calcFluxDSplitTensorDiss3d, dscale, .true., rrhs)
            end select
          ...
          case (DISSIPATION_RUSANOV_DSPLIT)
            ...
            case (NDIM2D)
              call gfsys_buildResidual(rproblemLevel&
                  %Rmatrix(coeffMatrix_CX:coeffMatrix_CY),&
                  rproblemLevel%Rafcstab(inviscidAFC), rsolution,&
                  eulerlagrange_calcFluxDSplitRusanov2d, dscale, .true., rrhs)
              
            case (NDIM3D)
              call gfsys_buildResidual(rproblemLevel&
                  %Rmatrix(coeffMatrix_CX:coeffMatrix_CZ),&
                  rproblemLevel%Rafcstab(inviscidAFC), rsolution,&
                  eulerlagrange_calcFluxDSplitRusanov3d, dscale, .true., rrhs)
            end select
      ...
      case (DISSIPATION_SCALAR_DSPLIT)
        ...
        case (NDIM2D)
          call gfsys_buildResidual(rproblemLevel&
              %Rmatrix(coeffMatrix_CX:coeffMatrix_CY), rproblemLevel&
              %Rafcstab(inviscidAFC), rsolution,&
              eulerlagrange_calcFluxDSplitScalarDiss2d, dscale, .false., rres)
          
        case (NDIM3D)
          call gfsys_buildResidual(rproblemLevel&
              %Rmatrix(coeffMatrix_CX:coeffMatrix_CZ), rproblemLevel&
              %Rafcstab(inviscidAFC), rsolution,&
              eulerlagrange_calcFluxDSplitScalarDiss3d, dscale, .false., rres)
        end select
      ...
      case (DISSIPATION_TENSOR_DSPLIT)
        ...
        case (NDIM2D)
          call gfsys_buildResidual(rproblemLevel&
              %Rmatrix(coeffMatrix_CX:coeffMatrix_CY), rproblemLevel&
              %Rafcstab(inviscidAFC), rsolution,&
              eulerlagrange_calcFluxDSplitTensorDiss2d, dscale, .false., rres)
          
        case (NDIM3D)
          call gfsys_buildResidual(rproblemLevel&
              %Rmatrix(coeffMatrix_CX:coeffMatrix_CZ), rproblemLevel&
              %Rafcstab(inviscidAFC), rsolution,&
              eulerlagrange_calcFluxDSplitTensorDiss3d, dscale, .false., rres)
        end select
      ...
      case (DISSIPATION_RUSANOV_DSPLIT)
        ...
        case (NDIM2D)
          call gfsys_buildResidual(rproblemLevel&
              %Rmatrix(coeffMatrix_CX:coeffMatrix_CY), rproblemLevel&
              %Rafcstab(inviscidAFC), rsolution,&
              eulerlagrange_calcFluxDSplitRusanov2d, dscale, .false., rres)
          
        case (NDIM3D)
          call gfsys_buildResidual(rproblemLevel&
              %Rmatrix(coeffMatrix_CX:coeffMatrix_CZ), rproblemLevel&
              %Rafcstab(inviscidAFC), rsolution,&
              eulerlagrange_calcFluxDSplitRusanov3d, dscale, .false., rres)
        end select
...
!</subroutine>
    ...
    case (NDIM1D)
      call bdrf_filterSolution(rsolver%rboundaryCondition,&
          ...
          rsolution0, rtimestep%dTime, eulerlagrange_calcBoundaryvalues1d,&
          istatus)
      
    case (NDIM2D)
      call bdrf_filterSolution(rsolver%rboundaryCondition,&
          rproblemLevel%RmatrixBlock(imatrix), rsolution, rres,&
          rsolution0, rtimestep%dTime, eulerlagrange_calcBoundaryvalues2d,&
          istatus)

    case (NDIM3D)
      call bdrf_filterSolution(rsolver%rboundaryCondition,&
          rproblemLevel%RmatrixBlock(imatrix), rsolution, rres,&
          rsolution0, rtimestep%dTime, eulerlagrange_calcBoundaryvalues3d,&
          istatus)
...
!<subroutine>
  ...
  subroutine eulerlagrange_calcLinearizedFCT(rbdrCond, rproblemLevel,&
  ...
  contains
    ...
    subroutine buildFluxCons2d(Kdiagonal, IverticesAtEdge,&
      ...
      do iedge = 1, NEDGE
        ...
        call eulerlagrange_calcFluxRusanov2d(u(:,i), u(:,j),&
        ...
        call eulerlagrange_calcMatrixRusanovDiag2d(u(:,i), u(:,j),&
...
!!$          end select
  ...
  end subroutine eulerlagrange_calcLinearizedFCT
