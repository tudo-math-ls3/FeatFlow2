...
!# which are required to solve the compressible eulerlagrange/Navier-Stokes equations
!#
...
!<subroutine>
  ...
  pure subroutine eulerlagrange_getVarInterleaveFormat(neq, nvar, cvariable, Ddata, Dvalue)
...
!<subroutine>
  ...
  pure subroutine eulerlagrange_getVarBlockformat(neq, nvar, cvariable, Ddata, Dvalue)
