...
!#
!# 44.) eulerlagrange_moveparticles
...
!#
!# 46.) eulerlagrange_checkboundary
!#      -> Checks if there are collisions with the boundary
!#
!# 47.) eulerlagrange_calcvolpart
!#      -> Calculates the volume fraction of the particles in the gridpoints
!#
!# 48.) eulerlagrange_calcvelopart
...
module eulerlagrange_callback2d
  ...
  public :: eulerlagrange_moveparticles
...
!<input>
  ...
  end subroutine eulerlagrange_moveparticles
...
!write(*,*) rParticles%p_xvelo(iPart)
! Set force
F_ges(1)= F_D(1) + F_G(1)
F_ges(2)= F_D(2) + F_G(2)
...
!<subroutine>
  ...
  subroutine eulerlagrange_moveparticlestwoway2(rparlist,p_rproblemLevel,rsolutionPrimal,rParticles)
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!! TODO: hier muss noch die "richtige" partikelgeschwindigkeit berechnet werden 
!!!!!!!!!       (mit der Widerstandskraft und der Schwerkraft und so...
...
! call eulerlagrange_getgasvelocity(p_rproblemLevel,rParticles,iPart)
  ...
  end subroutine eulerlagrange_moveparticlestwoway2
