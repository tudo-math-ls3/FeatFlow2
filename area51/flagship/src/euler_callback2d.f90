...
!<subroutine>
  ...
  subroutine euler_setBoundary2d(rproblemLevel, rtimestep, rsolver,&
...
!</subroutine>
    ...
    case DEFAULT
      call output_line('Invalid nonlinear preconditioner!',&
                       OU_CLASS_ERROR,OU_MODE_STD,'euler_setBoundary2d')
      call sys_halt()
    end select
  end subroutine euler_setBoundary2d
