...
module zpinch_callback2d
  ...
  private
  public :: zpinch_calcFluxGalerkin2d
  public :: zpinch_calcFluxGalerkinNoBdr2d
  public :: zpinch_calcFluxScalarDiss2d
  public :: zpinch_calcFluxDSplitScalarDiss2d
  public :: zpinch_calcFluxTensorDiss2d
  public :: zpinch_calcFluxDSplitTensorDiss2d
  public :: zpinch_calcFluxRusanov2d
  public :: zpinch_calcFluxDSplitRusanov2d
  public :: zpinch_calcMatrixDiagonalDiag2d
  public :: zpinch_calcMatrixDiagonal2d
  public :: zpinch_calcMatrixGalerkinDiag2d
  public :: zpinch_calcMatrixGalerkin2d
  public :: zpinch_calcMatrixScalarDissDiag2d
  public :: zpinch_calcMatrixScalarDiss2d
  public :: zpinch_calcMatrixTensorDissDiag2d
  public :: zpinch_calcMatrixTensorDiss2d
  public :: zpinch_calcMatrixRusanovDiag2d
  public :: zpinch_calcMatrixRusanov2d
  public :: zpinch_calcCharacteristics2d
  public :: zpinch_calcBoundaryvalues2d
...
!<subroutine>
  ...
  subroutine zpinch_calcFluxGalerkin2d(U_i, U_j, C_ij, C_ji, dscale, F_ij, F_ji)
...
!</subroutine>
  ...
  end subroutine zpinch_calcFluxGalerkin2d

  !*****************************************************************************

!<subroutine>

  subroutine zpinch_calcFluxGalerkinNoBdr2d(U_i, U_j, C_ij, C_ji, dscale, F_ij, F_ji)
...
!</subroutine>
    ...
    ! quantities have a look at the subroutine "zpinch_calcFluxGalerkin2d".
    !---------------------------------------------------------------------------
  ...
  end subroutine zpinch_calcFluxGalerkinNoBdr2d

  !*****************************************************************************

!<subroutine>

  subroutine zpinch_calcFluxScalarDiss2d(U_i, U_j, C_ij, C_ji, dscale, F_ij, F_ji)
...
!</subroutine>
  ...
  end subroutine zpinch_calcFluxScalarDiss2d

  !*****************************************************************************

!<subroutine>

  subroutine zpinch_calcFluxDSplitScalarDiss2d(U_i, U_j, C_ij, C_ji, dscale, F_ij, F_ji)
...
!</subroutine>
  ...
  end subroutine zpinch_calcFluxDSplitScalarDiss2d

  !*****************************************************************************

!<subroutine>

  subroutine zpinch_calcFluxTensorDiss2d(U_i, U_j, C_ij, C_ji, dscale, F_ij, F_ji)
...
!</subroutine>
  ...
  end subroutine zpinch_calcFluxTensorDiss2d

  !*****************************************************************************

!<subroutine>

  subroutine zpinch_calcFluxDSplitTensorDiss2d(U_i, U_j, C_ij, C_ji, dscale, F_ij, F_ji)
...
!</subroutine>
  ...
  end subroutine zpinch_calcFluxDSplitTensorDiss2d

  !*****************************************************************************

!<subroutine>

  subroutine zpinch_calcFluxRusanov2d(U_i, U_j, C_ij, C_ji, dscale, F_ij, F_ji)
...
!</subroutine>
    ...
    dF1_ij(3) = U_i(3)*ui                        - U_j(3)*uj
    dF1_ij(4) = (GAMMA*U_i(4)-G2*(ru2i+rv2i))*ui - ((GAMMA*U_j(4)-G2*(ru2j+rv2j))*uj)
    dF1_ij(5) = U_i(2)*U_i(5)/U_i(1)             - U_j(2)*U_j(5)/U_j(1)
    ...
    dF2_ij(3) = G1*U_i(4)-G14*rv2i-G2*ru2i       - (G1*U_j(4)-G14*rv2j-G2*ru2j)
    dF2_ij(4) = (GAMMA*U_i(4)-G2*(ru2i+rv2i))*vi - (GAMMA*U_j(4)-G2*(ru2j+rv2j))*vj
    dF2_ij(5) = U_i(3)*U_i(5)/U_i(1)             - U_j(3)*U_j(5)/U_j(1)
  ...
  end subroutine zpinch_calcFluxRusanov2d

  !*****************************************************************************

!<subroutine>

  subroutine zpinch_calcFluxDSplitRusanov2d(U_i, U_j, C_ij, C_ji, dscale, F_ij, F_ji)
...
!</subroutine>
  ...
  end subroutine zpinch_calcFluxDSplitRusanov2d

  !*****************************************************************************

!<subroutine>

  subroutine zpinch_calcMatrixDiagonalDiag2d(U_i, C_ii, dscale, K_ii)
...
!</subroutine>
  ...
  end subroutine zpinch_calcMatrixDiagonalDiag2d

  !*****************************************************************************

!<subroutine>

  subroutine zpinch_calcMatrixDiagonal2d(U_i, C_ii, dscale, K_ii)
...
!</subroutine>
  ...
  end subroutine zpinch_calcMatrixDiagonal2d

  !*****************************************************************************

!<subroutine>

  subroutine zpinch_calcMatrixGalerkinDiag2d(U_i, U_j, C_ij, C_ji, dscale, K_ij, K_ji, D_ij)
...
!</subroutine>
  ...
  end subroutine zpinch_calcMatrixGalerkinDiag2d

  !*****************************************************************************

!<subroutine>

  subroutine zpinch_calcMatrixGalerkin2d(U_i, U_j, C_ij, C_ji, dscale, K_ij, K_ji, D_ij)
...
!</subroutine>
  ...
  end subroutine zpinch_calcMatrixGalerkin2d

  !*****************************************************************************

!<subroutine>

  subroutine zpinch_calcMatrixScalarDissDiag2d(U_i, U_j, C_ij, C_ji, dscale, K_ij, K_ji, D_ij)
...
!</subroutine>
  ...
  end subroutine zpinch_calcMatrixScalarDissDiag2d

!*****************************************************************************

!<subroutine>

  subroutine zpinch_calcMatrixScalarDiss2d(U_i, U_j, C_ij, C_ji, dscale, K_ij, K_ji, D_ij)
...
!</subroutine>
  ...
  end subroutine zpinch_calcMatrixScalarDiss2d

  !*****************************************************************************

!<subroutine>

  subroutine zpinch_calcMatrixTensorDissDiag2d(U_i, U_j, C_ij, C_ji, dscale, K_ij, K_ji, D_ij)
...
!</subroutine>
  ...
  end subroutine zpinch_calcMatrixTensorDissDiag2d

  !*****************************************************************************

!<subroutine>

  subroutine zpinch_calcMatrixTensorDiss2d(U_i, U_j, C_ij, C_ji, dscale, K_ij, K_ji, D_ij)
...
!</subroutine>
  ...
  end subroutine zpinch_calcMatrixTensorDiss2d

  !*****************************************************************************

!<subroutine>

  subroutine zpinch_calcMatrixRusanovDiag2d(U_i, U_j, C_ij, C_ji, dscale, K_ij, K_ji, D_ij)
...
!</subroutine>
    ...
    ! local variable
    real(DP), dimension(NDIM2D) :: a
    real(DP) :: anorm,aux,hi,hj,ui,uj,vi,vj,ci,cj,Ei,Ej
  ...
  end subroutine zpinch_calcMatrixRusanovDiag2d

  !*****************************************************************************

!<subroutine>

  subroutine zpinch_calcMatrixRusanov2d(U_i, U_j, C_ij, C_ji, dscale, K_ij, K_ji, D_ij)
...
!</subroutine>
    ...
    ! local variable
    real(DP), dimension(NDIM2D) :: a
    real(DP) :: anorm,aux,aux1,aux2,ci,cj,hi,hj,Ei,Ej,ui,uj,vi,vj,qi,qj,uvi,uvj,uPow2i,uPow2j,vPow2i,vPow2j
  ...
  end subroutine zpinch_calcMatrixRusanov2d

  !*****************************************************************************

!<subroutine>

  subroutine zpinch_calcCharacteristics2d(U_i, U_j, Dweight, W_ij, Lbd_ij, R_ij, L_ij)
...
!</subroutine>
  ...
  end subroutine zpinch_calcCharacteristics2d

  !*****************************************************************************

!<subroutine>

  subroutine zpinch_calcBoundaryvalues2d(DbdrNormal, DpointNormal, DbdrValue,&
...
!</subroutine>
      ...
      if (2.0_DP*G9*c .le. vn_b-vn) then
        if (present(istatus)) then
          ...
          call output_line('Riemann solver failed due to vacuum',&
                           OU_CLASS_ERROR,OU_MODE_STD,'zpinch_calcBoundaryvalues2d')
          call sys_halt()
        end if
      end if
  ...
  end subroutine zpinch_calcBoundaryvalues2d
    ...
    case(HADAPT_OPR_INITCALLBACK)
      ...
      if (rsolution%nblocks .ne. 1) then
        call output_line('Vector is not in interleave format!',&
                         OU_CLASS_WARNING,OU_MODE_STD,'zpinch_hadaptCallbackScalar2d')
        call sys_halt()
      end if
    ...
    case(HADAPT_OPR_INITCALLBACK)
      ...
      if (rsolution%nblocks .ne. NVAR2D) then
        call output_line('Vector is not in block format!',&
                         OU_CLASS_WARNING,OU_MODE_STD,'zpinch_hadaptCallbackBlock2d')
        call sys_halt()
      end if
