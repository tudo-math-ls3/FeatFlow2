...
module zpinch_callback1d
  ...
  private
  public :: zpinch_calcFluxGalerkin1d
  public :: zpinch_calcFluxGalerkinNoBdr1d
  public :: zpinch_calcFluxScalarDiss1d
  public :: zpinch_calcFluxTensorDiss1d
  public :: zpinch_calcFluxRusanov1d
  public :: zpinch_calcMatrixDiagonalDiag1d
  public :: zpinch_calcMatrixDiagonal1d
  public :: zpinch_calcMatrixGalerkinDiag1d
  public :: zpinch_calcMatrixGalerkin1d
  public :: zpinch_calcMatrixScalarDissDiag1d
  public :: zpinch_calcMatrixScalarDiss1d
  public :: zpinch_calcMatrixTensorDissDiag1d
  public :: zpinch_calcMatrixTensorDiss1d
  public :: zpinch_calcMatrixRusanovDiag1d
  public :: zpinch_calcMatrixRusanov1d
  public :: zpinch_calcCharacteristics1d
  public :: zpinch_calcBoundaryvalues1d
  public :: zpinch_hadaptCallbackScalar1d
  public :: zpinch_hadaptCallbackBlock1d
...
!<subroutine>
  ...
  subroutine zpinch_calcFluxGalerkin1d(U_i, U_j, C_ij, C_ji, dscale, F_ij, F_ji)
...
!</subroutine>
  ...
  end subroutine zpinch_calcFluxGalerkin1d

  !*****************************************************************************

!<subroutine>

  subroutine zpinch_calcFluxGalerkinNoBdr1d(U_i, U_j, C_ij, C_ji, dscale, F_ij, F_ji)
...
!</subroutine>
  ...
  end subroutine zpinch_calcFluxGalerkinNoBdr1d

  !*****************************************************************************

!<subroutine>

  subroutine zpinch_calcFluxScalarDiss1d(U_i, U_j, C_ij, C_ji, dscale, F_ij, F_ji)
...
!</subroutine>
  ...
  end subroutine zpinch_calcFluxScalarDiss1d

  !*****************************************************************************

!<subroutine>

  subroutine zpinch_calcFluxTensorDiss1d(U_i, U_j, C_ij, C_ji, dscale, F_ij, F_ji)
...
!</subroutine>
  ...
  end subroutine zpinch_calcFluxTensorDiss1d

  !*****************************************************************************

!<subroutine>

  subroutine zpinch_calcFluxRusanov1d(U_i, U_j, C_ij, C_ji, dscale, F_ij, F_ji)
...
!</subroutine>
  ...
  end subroutine zpinch_calcFluxRusanov1d

  !*****************************************************************************

!<subroutine>

  subroutine zpinch_calcMatrixDiagonalDiag1d(U_i, C_ii, dscale, K_ii)
...
!</subroutine>
  ...
  end subroutine zpinch_calcMatrixDiagonalDiag1d

  !*****************************************************************************

!<subroutine>

  subroutine zpinch_calcMatrixDiagonal1d(U_i, C_ii, dscale, K_ii)
...
!</subroutine>
  ...
  end subroutine zpinch_calcMatrixDiagonal1d

  !*****************************************************************************

!<subroutine>

  subroutine zpinch_calcMatrixGalerkinDiag1d(U_i, U_j, C_ij, C_ji, dscale, K_ij, K_ji, D_ij)
...
!</subroutine>
  ...
  end subroutine zpinch_calcMatrixGalerkinDiag1d

  !*****************************************************************************

!<subroutine>

  subroutine zpinch_calcMatrixGalerkin1d(U_i, U_j, C_ij, C_ji, dscale, K_ij, K_ji, D_ij)
...
!</subroutine>
  ...
  end subroutine zpinch_calcMatrixGalerkin1d

  !*****************************************************************************

!<subroutine>

  subroutine zpinch_calcMatrixScalarDissDiag1d(U_i, U_j, C_ij, C_ji, dscale, K_ij, K_ji, D_ij)
...
!</subroutine>
  ...
  end subroutine zpinch_calcMatrixScalarDissDiag1d

!*****************************************************************************

!<subroutine>

  subroutine zpinch_calcMatrixScalarDiss1d(U_i, U_j, C_ij, C_ji, dscale, K_ij, K_ji, D_ij)
...
!</subroutine>
  ...
  end subroutine zpinch_calcMatrixScalarDiss1d

  !*****************************************************************************

!<subroutine>

  subroutine zpinch_calcMatrixTensorDissDiag1d(U_i, U_j, C_ij, C_ji, dscale, K_ij, K_ji, D_ij)
...
!</subroutine>
  ...
  end subroutine zpinch_calcMatrixTensorDissDiag1d

  !*****************************************************************************

!<subroutine>

  subroutine zpinch_calcMatrixTensorDiss1d(U_i, U_j, C_ij, C_ji, dscale, K_ij, K_ji, D_ij)
...
!</subroutine>
  ...
  end subroutine zpinch_calcMatrixTensorDiss1d

  !*****************************************************************************

!<subroutine>

  subroutine zpinch_calcMatrixRusanovDiag1d(U_i, U_j, C_ij, C_ji, dscale, K_ij, K_ji, D_ij)
...
!</subroutine>
  ...
  end subroutine zpinch_calcMatrixRusanovDiag1d

  !*****************************************************************************

!<subroutine>

  subroutine zpinch_calcMatrixRusanov1d(U_i, U_j, C_ij, C_ji, dscale, K_ij, K_ji, D_ij)
...
!</subroutine>
  ...
  end subroutine zpinch_calcMatrixRusanov1d

  !*****************************************************************************

!<subroutine>

  subroutine zpinch_calcCharacteristics1d(U_i, U_j, Dweight, W_ij, Lbd_ij, R_ij, L_ij)
...
!</subroutine>
  ...
  end subroutine zpinch_calcCharacteristics1d

  !*****************************************************************************

!<subroutine>

  subroutine zpinch_calcBoundaryvalues1d(DbdrNormal, DpointNormal, DbdrValue,&
...
!</subroutine>
  ...
  end subroutine zpinch_calcBoundaryvalues1d

  !*****************************************************************************

!<subroutine>

  subroutine zpinch_hadaptCallbackScalar1d(rcollection, iOperation, Ivertices, Ielements)
...
!</subroutine>
    ...
    case(HADAPT_OPR_INITCALLBACK)
      ...
      if (rsolution%nblocks .ne. 1) then
        call output_line('Vector is not in interleave format!',&
                         OU_CLASS_WARNING,OU_MODE_STD,'zpinch_hadaptCallbackScalar1d')
        call sys_halt()
      end if
  ...
  end subroutine zpinch_hadaptCallbackScalar1d

  !*****************************************************************************

!<subroutine>

  subroutine zpinch_hadaptCallbackBlock1d(rcollection, iOperation, Ivertices, Ielements)
...
!</subroutine>
    ...
    case(HADAPT_OPR_INITCALLBACK)
      ...
      if (rsolution%nblocks .ne. NVAR1D) then
        call output_line('Vector is not in block format!',&
                         OU_CLASS_WARNING,OU_MODE_STD,'zpinch_hadaptCallbackBlock1d')
        call sys_halt()
      end if
  ...
  end subroutine zpinch_hadaptCallbackBlock1d
 
end module zpinch_callback1d
