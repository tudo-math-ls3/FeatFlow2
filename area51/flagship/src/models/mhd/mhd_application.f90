...
!</subroutine>
    ...
    call mhd_adjustParameterlist(rparlist, ssectionName)
    ...
    call mhd_initProblem(rparlist, ssectionName,&
    ...
    call mhd_initAllProblemLevels(rparlist, ssectionName,&
    ...
    ! Output statistics
    call mhd_outputStatistics(rtimerTotal, rcollection)
...
!<subroutine>
  ...
  subroutine mhd_initProblem(rparlist, ssectionName,&
      ...
      do iblock = 1, rvector%nblocks
        ...
        if (rvector%RvectorBlock(iblock)%NVAR .eq. 1) then
          ...
          call linf_buildVectorScalar2(rform, .true.,&
              rvector%RvectorBlock(iblock), mhd_coeffVectorAnalytic, rcollection)
          ...
          do ivar = 1, rvectorBlock%nblocks
            ...
            ! Assemble the linear form for the scalar subvector
            call linf_buildVectorScalar2(rform, .true.,&
                rvectorBlock%RvectorBlock(ivar), mhd_coeffVectorAnalytic,&
                rcollection)
          end do
      ...
      if (isolutionType .eq. SOLUTION_ANALYTIC_L2_CONSISTENT) then
        ...
        if (nsolutionfailsafe .gt. 0) then
          ...
          call afcstab_failsafeLimiting(rafcstab, p_rlumpedMassMatrix,&
              ...
              nsolutionfailsafe, mhd_getVariable, rvector)
...
!<subroutine>
  ...
  subroutine mhd_outputStatistics(rtimerTotal, rcollection)
...
!</subroutine>
    ...
    if (p_rdiscretisation%ncomponents .ne.&
      ...
      isize = rsolution%NEQ*mhd_getNVAR(p_rproblemLevel)
...
!<subroutine>
  ...
  subroutine mhd_adjustParameterlist(rparlist, ssectionName)
...
!</subroutine>
  ...
  end subroutine mhd_adjustParameterlist
