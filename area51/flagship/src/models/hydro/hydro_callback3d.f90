...
!</subroutine>
    ...
    do idx = 1, nedges
      ...
      d_ij = max( abs(RCONST(0.5)*(IDX3(DmatrixCoeffsAtEdge,1,1,idx,0,0,0)-&
           ...
           + max( abs(RCONST(0.5)*(IDX3(DmatrixCoeffsAtEdge,3,1,idx,0,0,0)-&
                                   IDX3(DmatrixCoeffsAtEdge,3,2,idx,0,0,0))*wj)+&
