...
!<subroutine>
  ...
  subroutine euler_calcMatrixRusanovDiag1d(U_i, U_j, C_ij, C_ji, dscale, K_ij, K_ji)
...
!<subroutine>
  ...
  subroutine euler_calcMatrixRusanov1d(U_i, U_j, C_ij, C_ji, dscale, K_ij, K_ji)
