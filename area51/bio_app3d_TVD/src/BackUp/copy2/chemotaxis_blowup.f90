...
!             print *,'!!!!!!!!!!!!!!!!!! c_z=',dnorm_z
	    ...
	    call chemo_artdiff( rK, dedge, kedge, nedge )
            !!!Rpbert call chemo_artdiff( rmassmatrix, rK, dedge, kedge, nedge, INFO_LEVEL )
            !**********************
...
!             end if
        ...
        !!!Rpbert call chemo_fct_lim ( rdiscretisation, rcell, kedge, dedge, nedge, &
        !!!Rpbert                      rtempLump, rlaplace, rK, dtstep, INFO_LEVEL )
...
!         call lsyssc_releaseMatrix (rlumpedmass)
    ...
    !##################################################################################
    !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    !!!!!   begin of chemo_readGMV subroutine  !!!!!
    !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
