...
!    end select
  ...
  end subroutine getReferenceFunction_2D
  ...
  end subroutine getCompareFunction_2D
  ...
  end subroutine coeff_RHS_Sin2D
  ...
  end subroutine getReferenceFunction_Sin2D
  ...
  end subroutine getBoundaryValuesFBC_2D
  ...
  end subroutine getBoundaryValuesMR_2D
  ...
  end subroutine gethadaptMonitorFunction_2D
...
!          end if
  ...
  end subroutine flux_dg_buildVectorScEdge2D_sim
...
!    call fparser_release(rfparser)
  ...
  end subroutine Euler_coeff_RHS_IC
  ...
  end subroutine coeff_Steadyproj
  ...
  end subroutine flux_dg_buildVectorBlEdge2D_sim
  ...
  end subroutine Callback_Sourceterm
...
!          DfluxValues(:,1,ipoint,iedge) = Euler_buildFlux_HLL2D(DQi,DQa,normal(1,iedge),normal(2,iedge))
  ...
  end subroutine Euler_flux_dg_buildVectorBlEdge2D_sim
  ...
  subroutine Euler_flux_dg_buildVectorBlEdge2D_sim_Newton (&
       !              Dcoefficients,&
       !              DsolVals,&
         DfluxValues,&
         rvectorSolBlock,&
...
!         DfluxValues(:,1,ipoint,iedge) = LLF(DQi,DQa,normal(1,iedge),normal(2,iedge)) 
  ...
  end subroutine Euler_flux_dg_buildVectorBlEdge2D_sim_Newton
  ...
  end subroutine Euler_flux_sys_block
  ...
  end subroutine Scalar_flux_dg_buildVectorBlEdge2D_sim
  ...
  end subroutine Scalar_flux_sys_block
  ...
  end subroutine Scalar_flux_sys_sc
  ...
  end subroutine Euler_flux_sys_sc
  ...
  end subroutine coeff_implicitDGconvection
  ...
  end subroutine flux_dg_implicitConvection_sim
  ...
  end subroutine flux_dg_implicitBurgers_sim
  ...
  subroutine flux_dg_implicitConvection_sim_Newton_ss (&
       !              Dcoefficients,&
       !              DsolVals,&
    DfluxValues,&
         rvectorSol,&
  ...
  end subroutine flux_dg_implicitConvection_sim_Newton_ss
  ...
  end subroutine coeff_implicitDGBurgers
  ...
  end subroutine getBoundaryValues_2D_zeros
  ...
  end subroutine getBoundaryValues_2D_rad
  ...
  end subroutine getBoundaryValues_2D_hump
  ...
  end subroutine getBoundaryValues_2D_ones
  ...
  end subroutine fcoeff_buildMatrixBl_sim_iSystem
  ...
  end subroutine flux_dg_buildMatrixBlEdge2D_sim_iSystem
  ...
  end subroutine fcoeff_buildMatrixBl_sim_iEuler
  ...
  end subroutine flux_dg_buildMatrixBlEdge2D_sim_iEuler
  ...
  subroutine flux_dg_buildMatrixBlEdge2D_sim_iEuler_Newton (&
 !            Dcoefficients,&
 !            DsolVals,&
              DfluxValues,&
              rvectorSol,&
...
!             DpointsReal,&
          ...
          do iterm = 1, size(DfluxValues,3)
            ...
            select case (iterm)
              case (1) ! For first term
                ...
                ! Inner DOFs
                Dside(:,:,1,iterm,ipoint,iedge) = 1.0_dp
                Dside(:,:,2,iterm,ipoint,iedge) = 0.0_dp
              ...
              case (2) ! For second term
                ...
                ! Outer DOFs
                Dside(:,:,1,iterm,ipoint,iedge) = 0.0_dp
                Dside(:,:,2,iterm,ipoint,iedge) = 1.0_dp
  ...
  end subroutine flux_dg_buildMatrixBlEdge2D_sim_iEuler_Newton
  ...
  subroutine flux_dg_buildMatrixBlEdge2D_sim_iEuler_Newton_ss (&
 !            Dcoefficients,&
 !            DsolVals,&
              DfluxValues,&
              rvectorSol,&
...
!              dE = 2.5_dp+0.125_dp*1.4_dp
              ...
              dpr = (gamma-1.0_dp)*drho*(dE-0.5_dp*( du*du + dv*dv ) )
              dH = dE + dpr/drho
              dc = sqrt((gamma-1.0_dp)*(dH-0.5_dp*( du*du + dv*dv ) ))
...
!                DfluxValues(:,:,iterm,ipoint,iedge) = 0.0_dp
  ...
  end subroutine flux_dg_buildMatrixBlEdge2D_sim_iEuler_Newton_ss
  ...
  subroutine flux_convection_rhs_sc (rdiscretisation,rform, &
       nelements,npointsPerElement,Dpoints, &
       IdofsTest,rdomainIntSubset,&
       Dcoefficients,rcollection)
    ...
    do iel = 1, size(Dcoefficients,4)
       do ipoint = 1, size(Dcoefficients,3)
  ...
  end subroutine flux_convection_rhs_sc
  
  
  
  
  subroutine flux_convection_edge_sc_sim (&
       !              Dcoefficients,&
       !              DsolVals,&
         DfluxValues,&
         rvectorSolBlock,&
    ...
    ! If the solution (or its derivatives) has to be evaluated
    allocate(Dsolutionvalues(2,ubound(DfluxValues,3),ubound(DfluxValues,4)))
    ! Get values on the one side of the edge
    call fevl_evaluate_sim4 (rcollection%p_rvectorQuickAccess1%RvectorBlock(1), &
         rIntSubset(1), DER_FUNC, Dsolutionvalues, 1)
    ! Get values on the other side of the edge
    ...
    do iel = 1, ubound(DfluxValues,4)
       ...
       do ipoint= 1, ubound(DfluxValues,3)
          ...
          if (IelementList(iel)==0) then
            ...
            if (abs(dx-1.0_dp)<10.0_dp*SYS_EPSREAL_DP) Dsolutionvalues(2,ipoint,iel) = 1.0_dp+dy
            if ((dy.le.0.0_dp)) Dsolutionvalues(2,ipoint,iel) = dx
          ...
          ! Upwind flux
          if (dvn.ge.0) then
             DfluxValues(1,1,ipoint,iel) = dvn *Dsolutionvalues(1,ipoint,iel)
          else
             DfluxValues(1,1,ipoint,iel) = dvn *Dsolutionvalues(2,ipoint,iel)
          end if
  ...
  end subroutine flux_convection_edge_sc_sim
  ...
  subroutine iConv_flux_dg_buildVectorBlEdge2D_sim_Newton (&
       !              Dcoefficients,&
       !              DsolVals,&
         DfluxValues,&
         rvectorSolBlock,&
  ...
  end subroutine iConv_flux_dg_buildVectorBlEdge2D_sim_Newton
  ...
  subroutine iConv_flux_sys_block (rdiscretisation,rform, &
       nelements,npointsPerElement,Dpoints, &
       IdofsTest,rdomainIntSubset,&
       Dcoefficients,rcollection)
  ...
  end subroutine iConv_flux_sys_block
  ...
  subroutine fcoeff_buildMatrixBl_sim_iConvNewton (rdiscretisationTrial,&
       rdiscretisationTest, rform, nelements, npointsPerElement,&
       Dpoints, IdofsTrial, IdofsTest, rdomainIntSubset,&
       Dcoefficients, rcollection)
  ...
  end subroutine fcoeff_buildMatrixBl_sim_iConvNewton
  ...
  subroutine flux_dg_buildMatrixBlEdge2D_sim_iConv_Newton_ss (&
 !            Dcoefficients,&
 !            DsolVals,&
              DfluxValues,&
              rvectorSol,&
...
!             DpointsReal,&
  ...
  end subroutine flux_dg_buildMatrixBlEdge2D_sim_iConv_Newton_ss
  ...
  !<subroutine>
    ...
    subroutine fcoeff_MatrixScalarMgCell (rdiscretisationTrial,&
                  rdiscretisationTest, rform, nelements, npointsPerElement,&
                  Dpoints, IdofsTrial, IdofsTest, rdomainIntSubset,&
                  Dcoefficients, rcollection)
  ...
  !</subroutine>
    ...
    subroutine flux_dg_MatrixScalarMgEdge (&
			  DfluxValues,&
			  rvectorSol,&
			  IelementList,&
			  Dside,&
...
!!          end if
    ...
    subroutine flux_dg_VectorScalarMgEdge (&
              Dcoefficients,&
              IelementList,&
              normal,&
              rintSubSet,&
  ...
  !</subroutine>
    ...
    ! Now we have
    ! Dsolutionvalues(1,ipoint,iedge) on the first side
    ! and
    ...
    do iedge = 1, ubound(Dcoefficients,3)
       ...
       do ipoint= 1, ubound(Dcoefficients,2)
          ...
          ! Velocity * normal
          dvn = Dvel(1)*normal(1,iedge)+Dvel(2)*normal(2,iedge)
...
!            Dsolutionvalues(2,ipoint,iedge) = 1.0_dp
          ...
          ! Upwind flux
          if (dvn.ge.0.0_dp) then
             Dcoefficients(1,ipoint,iedge) = dvn *Dsolutionvalues(1,ipoint,iedge)
          else
...
!!          end if
    ...
    ! Deallocate space for solution values
    deallocate(Dsolutionvalues)
  ...
  subroutine fcoeff_VectorScalarMgEdge (rdiscretisation,rform, &
       nelements,npointsPerElement,Dpoints, &
       IdofsTest,rdomainIntSubset,&
       Dcoefficients,rcollection)
    ...
    do iel = 1, size(Dcoefficients,3)
       do ipoint = 1, size(Dcoefficients,2)
          ...
          ! Set the coefficients
          Dcoefficients (1,ipoint,iel) = -dy*dQ(1)
          Dcoefficients (2,ipoint,iel) = dx*dQ(1)

       end do
    end do

    ! Deallocate solution values
    deallocate(DsolutionValues)
...
!              DfluxValues(1,ipoint,iedge) = 0.0_dp
!            end if
             if ((beta1*normal(1,iedge) + beta2*normal(2,iedge))<0.0_dp) then
               DfluxValues(1,ipoint,iedge) = 0.0_dp
             end if
          end if
...
!        Dvalues(i,j) = Dvalues(i,j)*Dvalues(i,j)
  ...
  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    subroutine dgmcd_fcoeff_MatrixScalarMgCell (rdiscretisationTrial,&
                  rdiscretisationTest, rform, nelements, npointsPerElement,&
                  Dpoints, IdofsTrial, IdofsTest, rdomainIntSubset,&
                  Dcoefficients, rcollection)
...
!<subroutine>
    ...
    subroutine dgmcd_flux_dg_MatrixScalarMgEdge (&
			  DCoefficients,&
			  IelementList,&
        normal,&
        DedgeLength,&
  ...
  subroutine dgmcd_VectorScalarMg (rdiscretisation,rform, &
       nelements,npointsPerElement,Dpoints, &
       IdofsTest,rdomainIntSubset,&
       Dcoefficients,rcollection)
...
!    end do
  ...
  !<subroutine>
    ...
    subroutine dgmcd_flux_dg_VectorScalarMgEdge (&
              Dcoefficients,&
              IelementList,&
              Dnormal,&
              DedgeLength,&
