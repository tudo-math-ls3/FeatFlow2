...
##############################################################################
# ATLAS (Automatically Tuned Linear Algebra Software) BLAS
#
# ATLAS is a portably efficient BLAS implementation, but contains only
# few routines from LAPACK so far. Use local lapack.
##############################################################################
BUILDLIB      := $(BUILDLIB) lapack
LIBDIR        := $(LIBDIR) -L/usr/local/lib/atlas/$(LIBID)
LIBS          := $(LIBS) -llapack -lcblas -lf77blas -latlas
