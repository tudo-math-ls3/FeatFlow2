...
!   use anisotropicdiffusion_methodMK1
  use anisotropicdiffusion_methodMK2
  use anisotropicdiffusion_methodMG2
  ...
  if (sys_getenv_string('LOGDIR',slogdir) .and. &
    ...
    call output_init ('./log/MK_Q2_GS_vec1_1_rhs_1_b_10000_row_btwiceGS.txt')
  end if
...
!   call anisotropicdiffusion2
 ...
 ! Call the problem to solve.
  call output_lbrk ()
  call output_line ('Calculating anisotropic diffusion problem with Multilevel Krylov method')
  call output_line ('-------------------------------------------------------')
  call anisotropicdiffusionMK2
  
! ! Call the problem to solve.
!   call output_lbrk ()
!   call output_line ('Calculating anisotropic diffusion problem with Multi Grid method')
!   call output_line ('-------------------------------------------------------')
!   call anisotropicdiffusionMG2
