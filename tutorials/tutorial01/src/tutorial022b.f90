!##############################################################################
!# Tutorial 022b: Calculate an L2 and H1 norm, standard integration, subdomain
!##############################################################################
...
!</subroutine>
  ...
  subroutine start_tutorial022b
    ...
    call output_line ("This is FEAT-2. Tutorial 022b")
    ...
    call pperr_scalar (PPERR_L2ERROR, dintvalue, rx%RvectorBlock(1),&
        ffunctionWeight=fcharFunctionSubdomain,rcubatureInfo=rcubatureInfo)
