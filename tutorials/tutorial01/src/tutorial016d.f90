!##############################################################################
!# Tutorial 016d: Solve simple linear system with BiCGStab solver, ILU prec.
!##############################################################################
...
!</subroutine>
  ...
  subroutine start_tutorial016d
    ...
    call output_line ("This is FEAT-2. Tutorial 016d")
    ...
    ! Create a BiCGStab solver with ILU(0) preconditioner
    ...
    call ucd_startVTK (rexport,UCD_FLAG_STANDARD,rtriangulation,"post/tutorial016d.vtk")
