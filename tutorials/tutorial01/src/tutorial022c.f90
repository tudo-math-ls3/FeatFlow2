!##############################################################################
!# Tutorial 022c: Calculate an L2 and H1 error with standard integration
!##############################################################################
...
!</subroutine>
  ...
  subroutine start_tutorial022c
    ...
    call output_line ("This is FEAT-2. Tutorial 022c")
    ...
    call pperr_scalar (PPERR_L2ERROR, dintvalue, rx%RvectorBlock(1), &
        fcalc_reffunction,rcubatureInfo=rcubatureInfo)
