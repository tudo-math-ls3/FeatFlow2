!##############################################################################
!# Tutorial 016e: Solve simple linear system with GMRES solver, ILU prec.
!##############################################################################
...
!</subroutine>
  ...
  subroutine start_tutorial016e
    ...
    call output_line ("This is FEAT-2. Tutorial 016e")
    ...
    ! Create a GMRES(k) solver with ILU(0) preconditioner.
    ! The dimension of the minimisation space for GMRES is set to k=10.
    ...
    call ucd_startVTK (rexport,UCD_FLAG_STANDARD,rtriangulation,"post/tutorial016e.vtk")
