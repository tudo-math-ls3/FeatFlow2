!##############################################################################
!# Tutorial 016a: Solve simple linear system with Gauss elimination
!##############################################################################
...
!</subroutine>
  ...
  subroutine start_tutorial016a
    ...
    call output_line ("This is FEAT-2. Tutorial 016a")
    ...
    call ucd_startVTK (rexport,UCD_FLAG_STANDARD,rtriangulation,"post/tutorial016a.vtk")
