...
extern "C" {
  ...
  int  meshadaptbase_mp_madapt_step_fromfile_(struct t_meshAdapt*, char*, int*, double*, double*, int*, int);
  int  meshadaptbase_mp_madapt_step_sngl2_(struct t_meshAdapt*, int*, float*, int*, float*, float*, int*);
  int  meshadaptbase_mp_madapt_step_dble2_(struct t_meshAdapt*, int*, double*, int*, double*, double*, int*);
