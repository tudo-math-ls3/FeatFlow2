  ...
  if(cx .ne. __MatOne__) then
    ...
    if(cy .eq. __VecOne__) then
      ...
      do irow = 1, NEQ
        ...
        do ivar = 1, __NVAR__
          Dy(__NVAR__*(KrowIdx(irow)-1)+ivar) = cx*Ddtmp(ivar)
        end do
      end do
      !$omp end parallel do
      ...
      do irow = 1, NEQ
        ...
        do ivar = 1, __NVAR__
          Dy(__NVAR__*(KrowIdx(irow)-1)+ivar) = Dy(__NVAR__*(KrowIdx(irow)-1)+ivar) + cx*Ddtmp(ivar)
        end do
      end do
      !$omp end parallel do
      ...
      do irow = 1, NEQ
        ...
        do ivar = 1, __NVAR__
          Dy(__NVAR__*(KrowIdx(irow)-1)+ivar) = cy*Dy(__NVAR__*(KrowIdx(irow)-1)+ivar) + cx*Ddtmp(ivar)
        end do
      end do
      !$omp end parallel do
    ...
    if(cy .eq. __VecOne__) then
      ...
      do irow = 1, NEQ
        ...
        do ivar = 1, __NVAR__
          Dy(__NVAR__*(KrowIdx(irow)-1)+ivar) = Ddtmp(ivar)
        end do
      end do
      !$omp end parallel do
      ...
      do irow = 1, NEQ
        ...
        do ivar = 1, __NVAR__
          Dy(__NVAR__*(KrowIdx(irow)-1)+ivar) = Dy(__NVAR__*(KrowIdx(irow)-1)+ivar) + Ddtmp(ivar)
        end do
      end do
      !$omp end parallel do
      ...
      do irow = 1, NEQ
        ...
        do ivar = 1, __NVAR__
          Dy(__NVAR__*(KrowIdx(irow)-1)+ivar) = cy*Dy(__NVAR__*(KrowIdx(irow)-1)+ivar) + Ddtmp(ivar)
        end do
      end do
      !$omp end parallel do
