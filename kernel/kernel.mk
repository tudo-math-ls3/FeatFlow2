...
KERNELSRC:=fsystem.f90 basicgeometry.f90 geometryaux.f90 afc_util.f90  \
	...
	error.f90 element.f90 io.f90 boundary.f90 boundarycondition.f90\
	...
	coarsegridcorrection.f90 feevaluation.f90\
