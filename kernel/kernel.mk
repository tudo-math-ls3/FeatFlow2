...
KERNELSRC:=fsystem.f90 basicgeometry.f90 geometryaux.f90 afcutil.f90	\
	...
	externalstorage.f90 cubature.f90 transformation.f90		\
	triangulation.f90 elementbase.f90 element_line1d.f90		\
	element_tri2d.f90 element_quad2d.f90 element_tetra3d.f90	\
	element_hexa3d.f90 element_pyra3d.f90 element_prism3d.f90	\
	scalarpde.f90 error.f90 element.f90 io.f90 boundary.f90		\
	fictitiousboundary.f90 boundarycondition.f90 paramlist.f90	\
	spatialdiscretisation.f90 dofmapping.f90 discretebc.f90		\
	discretefbc.f90 linearsystemscalar.f90 linearsystemblock.f90	\
	globalsystem.f90 matrixmodification.f90 matrixfilters.f90	\
	sortstrategy.f90 spdiscprojection.f90 multilevelprojection.f90	\
	domainintegration.f90 coarsegridcorrection.f90			\
	feevaluation.f90 vectorfilters.f90 filtersupport.f90 vanka.f90	\
	linearsolver.f90 linearsolverautoinitialise.f90 collection.f90	\
	...
	geometry.f90 mprimitives.f90 hadaptivity.f90 list.f90		\
	binarytree.f90 arraylist.f90 graph.f90 octree.f90		\
	triasearch.f90 statistics.f90 meshmodification.f90 mapleio.f90	\
	jumpstabilisation.f90 boundaryintegral.f90			\
	afcstabilisation.f90 groupfemscalar.f90 hadaptaux.f90		\
	hadaptaux1d.f90 hadaptaux2d.f90 hadaptaux3d.f90			\
	groupfemsystem.f90 meshregion.f90 pprocsolution.f90		\
	elementpreprocessing.f90 iluk.f90 gmvwritef.c			\
	multileveloperators.f90 adjacency.f90 meshadjacency.f90		\
	vanka_navst2d.f90 vanka_bouss2d.f90 uuid.f90 fpersistence.f90	\
	quicksolver.f90 pprocindicator.f90
...
vpath %.f $(KERNEL)/System $(KERNEL)/BasicGeometry			\
	...
	$(KERNEL)/DataStructures $(KERNEL)/Preprocessing $(KERNEL)	\
	$(INCOMING)
