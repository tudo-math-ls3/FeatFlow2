...
* IFD1n                                                                *
*                                                                      *
* Purpose  Calculate ILU decomposition of a matrix DA                  *
...
C
      SUB='IFD17'
      IF (ICHECK.GE.997) CALL OTRC('IFD17 ','12/02/89')
C
      IF (ILU.EQ.1) THEN
C
