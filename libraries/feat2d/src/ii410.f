...
*                                                                      *
* This routine is the same like II010 except for that this can be used *
* as the coarse grid solver in multigrid.                              *
* This is to prevent recursive calls when using BiCGStab as a solver,  *
* MG as preconditioner and BiCGStab as a coarse grid solver.           *
*                                                                      *
...
************************************************************************
C
      SUBROUTINE II410(DX,DB,NEQ,NIT,ITE,EPS,DAX0,DCG0C,BNOCON,
