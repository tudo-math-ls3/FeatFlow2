...
*          Call of AA09                                                *
*                                                                      *
* Subroutines/functions called  AA09, ZNEW, ZDISP, ZLEN, ZTYPE, ZCLEAR *
*                                                                      *
...
* For the description of the remaining parameters see AA09             *
*                                                                      *
* OUTPUT   TYPE                                                        *
* ------   ----                                                        *
...
*          bilinear forms  a(u,v)                                      *
*          Triangular elements - linear transformation                 *
...
************************************************************************
C
      SUBROUTINE XAA09(LA,LCOL,LLD,NA,NBLOC,ICLEAR,
...
C
      SUB='XAA09'
      IF (ICHECK.GE.997) CALL OTRC('XAA09 ','12/04/90')
      IER=0
C
      DO 1 IBLOC=1,NBLOC
...
2     CONTINUE
C
      CALL AA09(DWORK(1),KWORK(L(LCOL)),KWORK(L(LLD)),NA,NBLOC,
...
C
      SUB='AA09'
      IF (ICHECK.GE.997) CALL OTRC('AA09  ','12/04/90')
C
