...
C
      SUB='E010'
      IF (ICHECK.GE.998) CALL OTRC('E010  ','01/02/89')
C
      IER=0
...
10    IF (ICHECK.EQ.0) GOTO 1000
      IF (DETJ.LT.0D0) CALL WERR(-130,'E010  ')
      IF (DETJ.GT.0D0.AND.DETJ.LT.1D-70) CALL WERR(-132,'E010  ')
