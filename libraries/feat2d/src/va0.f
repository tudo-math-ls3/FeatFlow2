...
*          Call of VA0                                                 *
*                                                                      *
* Subroutines/functions called  VA0, ZNEW, ZDISP, ZLEN, ZTYPE, ZCLEAR  *
*                                                                      *
...
* For the description of the remaining parameters see VA0              *
*                                                                      *
* OUTPUT   TYPE                                                        *
* ------   ----                                                        *
...
C
      SUB='XVA0'
      IF (ICHECK.GE.997) CALL OTRC('XVA0  ','12/04/90')
      IER=0
C
      DO 1 IBLOC=1,NBLOC
...
2     CONTINUE
C
      CALL VA0(DWORK(1),NBLOC,KWORK(L(LOFF)),KWORK(L(LVERT)),
...
C
C
      SUBROUTINE VA0(DB,NBLOC,KOFF,KVERT,KMID,DCORVG,
...
C
      SUB='VA0'
      IF (ICHECK.GE.997) CALL OTRC('VA0   ','12/04/90')
C
