...
*          Call of AA07                                                *
*                                                                      *
* Subroutines/functions called  AA07, ZNEW, ZDISP, ZLEN, ZTYPE, ZCLEAR *
*                                                                      *
...
* For the description of the remaining parameters see AA07             *
*                                                                      *
* OUTPUT   TYPE                                                        *
* ------   ----                                                        *
...
************************************************************************
C
      SUBROUTINE XAA07(LA,LCOL,LLD,NA,NEQ,NBLOC,ICLEAR,ELE,
...
C
      SUB='XAA07'
      IF (ICHECK.GE.997) CALL OTRC('XAA07 ','12/04/90')
      IER=0
C
      DO 1 IBLOC=1,NBLOC
...
2     CONTINUE
C
      CALL AA07(DWORK(1),KWORK(L(LCOL)),KWORK(L(LLD)),NA,NEQ,
...
C
C
      SUBROUTINE AA07(DA,KCOL,KLD,NA,NEQ,NBLOC,KOFF,KVERT,KMID,
...
C
      SUB='AA07'
      IF (ICHECK.GE.997) CALL OTRC('AA07  ','12/04/90')
C
