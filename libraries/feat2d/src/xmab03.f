...
*          (multigrid version)                                         *
*          Successive call of XAB03                                    *
*                                                                      *
* Subroutines/functions called  XAB03                                  *
*                                                                      *
...
* KLDIA    I*4    NLEV numbers of pointer vectors                      * 
* KLDIAS   I*4                                                         *
* KNDIA    I*4    NLEV numbers of diagonal rows                        *
* NBLOC    I*4                                                         *
* ICLEAR   I*4                                                         *
* ELE      SUBR                                                        *
* COEFF    SUBR                                                        *
* BCON     L*4                                                         *
* KAB      I*4    See parameters of XAB03 and AB03                     *
* KABN     I*4                                                         *
* ICUB     I*4                                                         *
* ISYMM    I*4                                                         *
...
C
      ...
      DIMENSION KLA(NBLOC,*),KLDIA(*),KLDIAS(*),KNDIA(*)
...
C
      SUB='XMAB03'
      IF (ICHECK.GE.993) CALL OTRC('XMAB03','02/18/91')
      IER=0
C
C
...
C
      ...
      LMBDP =KLMBDP(ILEV)
C
      CALL XAB03(KLA(1,ILEV),KLDIA(ILEV),KLDIAS(ILEV),KNDIA(ILEV),
     *           KNA(ILEV),KNEQ(ILEV),NBLOC,ICLEAR,ELE,COEFF,BCON,
