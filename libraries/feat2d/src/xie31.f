...
************************************************************************
C
      SUBROUTINE XIE313(LA,LDIA,LDIAS,NDIA,LX,LB,NEQ,NIT,
     *                  ITE,EPS,OMEGA,DCG0C)
C
...
C
C
      SUBROUTINE XIE314(LA,LDIA,LDIAS,NDIA,LX,LB,NEQ,NIT,
     *                  ITE,EPS,OMEGA,DCG0C)
C
      IMPLICIT DOUBLE PRECISION (A,C-H,O-U,W-Z),LOGICAL(B)
      CHARACTER SUB*6,FMT*15,CPARAM*120
...
C
      SUB='XIE314'
      IF (ICHECK.GE.997) CALL OTRC('XIE314','02/01/91')
C
      CALL ZTYPE(LX,ITYPE1)
      CALL ZTYPE(LB,ITYPE2)
      CALL ZTYPE(LA,ITYPE3)
      IF (ITYPE1.NE.1.OR.ITYPE2.NE.1.OR.ITYPE3.NE.1) THEN
       CALL WERR(-170,'XIE314')
       GOTO 99999
      ENDIF
C
      IREQ=4*NEQ
...
C
C
      SUBROUTINE XIE317(LA,LCOL,LLD,LX,LB,NEQ,NIT,ITE,EPS,OMEGA,DCG0C)
C
      IMPLICIT DOUBLE PRECISION (A,C-H,O-U,W-Z),LOGICAL(B)
      CHARACTER SUB*6,FMT*15,CPARAM*120
      PARAMETER (NNARR=299)
...
C
      SUB='XIE317'
      IF (ICHECK.GE.997) CALL OTRC('XIE317','11/12/89')
C
      CALL ZTYPE(LX,ITYPE1)
      CALL ZTYPE(LB,ITYPE2)
      CALL ZTYPE(LA,ITYPE3)
      IF (ITYPE1.NE.1.OR.ITYPE2.NE.1.OR.ITYPE3.NE.1) THEN
       CALL WERR(-170,'XIE317')
       GOTO 99999
      ENDIF
C
      IREQ=4*NEQ
...
C
C
      SUBROUTINE XIE318(LA,LCOL,LLD,LX,LB,NEQ,NIT,ITE,EPS,OMEGA,DCG0C)
C
      IMPLICIT DOUBLE PRECISION (A,C-H,O-U,W-Z),LOGICAL(B)
      CHARACTER SUB*6,FMT*15,CPARAM*120
      PARAMETER (NNARR=299)
...
C
      SUB='XIE318'
      IF (ICHECK.GE.997) CALL OTRC('XIE318','11/12/89')
C
      CALL ZTYPE(LX,ITYPE1)
      CALL ZTYPE(LB,ITYPE2)
      CALL ZTYPE(LA,ITYPE3)
      IF (ITYPE1.NE.1.OR.ITYPE2.NE.1.OR.ITYPE3.NE.1) THEN
       CALL WERR(-170,'XIE318')
       GOTO 99999
      ENDIF
C
      IREQ=4*NEQ
...
C
C
      SUBROUTINE XIE31A(LA,LCOL,LLD,LOP,LX,LB,NEQ,NIT,ITE,EPS,OMEGA,
     *                  DCG0C)
C
      IMPLICIT DOUBLE PRECISION (A,C-H,O-U,W-Z),LOGICAL(B)
      CHARACTER SUB*6,FMT*15,CPARAM*120
...
C
      SUB='XIE31A'
      IF (ICHECK.GE.997) CALL OTRC('XIE31A','11/12/89')
C
      CALL ZTYPE(LX,ITYPE1)
      CALL ZTYPE(LB,ITYPE2)
      CALL ZTYPE(LA,ITYPE3)
      IF (ITYPE1.NE.1.OR.ITYPE2.NE.1.OR.ITYPE3.NE.1) THEN
       CALL WERR(-170,'XIE31A')
       GOTO 99999
      ENDIF
C
      IREQ=4*NEQ
