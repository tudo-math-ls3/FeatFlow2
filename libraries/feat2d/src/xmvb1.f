...
*          (multigrid version)                                         *
*          Successive call of XVB1                                     *
*                                                                      *
* Subroutines/functions called  XVB1                                   *
*                                                                      *
...
* NBLOC    I*4                                                         *
* ICLEAR   I*4                                                         *
* TMAX     R*8    See parameters of XVB1 and VB1                       *
* DPAR1    R*8                                                         *
* DPAR2    R*8                                                         *
* ELE      SUBR                                                        *
* COEFF    SUBR                                                        *
...
C
      SUB='XMVB1'
      IF (ICHECK.GE.997) CALL OTRC('XMVB1 ','02/18/91')
      IER=0
C
...
C
      ...
      LMBDP =KLMBDP(ILEV)
C
      CALL XVB1(KLB(1,ILEV),KNEQ(ILEV),NBLOC,ICLEAR,
