...
*          by successive calls of XSA0X  (two-level ordering)          *
*                                                                      *
* Subroutines/functions called  XSA0X, WERR, ZCPY                      *
*                                                                      *
...
* IVEL     I*4                                                         *
* IDISP    I*4                                                         *
* IBDP     I*4     See parameter list of XSA0X                         *
* S2DI     SUBR                                                        *
* S2DB     SUBR                                                        *
* PARX     FNCT                                                        *
* PARY     FNCT                                                        *
...
C
      SUB='XMSA0 '
      IF (ICHECK.GE.997) CALL OTRC('XMSA0 ','04/12/91')
C
...
C
      ...
      ENDIF
      IF (ILEV.EQ.1) THEN
       CALL XSA0X(0,IMID,IADJ0,IVEL,IDISP,IBDP0,
     *            S2DI,S2DB,PARX,PARY,TMAX)
      ELSE
       CALL XSA0X(1,IMID,IADJ0,IVEL,IDISP,IBDP0,
     *            S2DI,S2DB,PARX,PARY,TMAX)
      ENDIF
C
C
