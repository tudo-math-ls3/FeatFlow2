...
*          (multigrid version)                                         *
*          Successive call of XVA1                                     *
*                                                                      *
* Subroutines/functions called  XVA1                                   *
*                                                                      *
...
* NBLOC    I*4                                                         *
* ICLEAR   I*4                                                         *
* TMAX     R*8    See parameters of XVA1 and VA1                       *
* DPAR1    R*8                                                         *
* DPAR2    R*8                                                         *
* ELE      SUBR                                                        *
* COEFF    SUBR                                                        *
...
C
      SUB='XMVA1'
      IF (ICHECK.GE.997) CALL OTRC('XMVA1 ','02/18/91')
      IER=0
C
...
C
      ...
      LMBDP =KLMBDP(ILEV)
C
      CALL XVA1(KLB(1,ILEV),KNEQ(ILEV),NBLOC,ICLEAR,
     *          TMAX,DPAR1,DPAR2,IBCT,ELE,COEFF,BCON,
     *          KB,KBN,ICUB,CARR(1,ILEV),BSNGL(1,ILEV))
