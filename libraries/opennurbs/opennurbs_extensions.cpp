      ...
      )
{
  ...
  if ( count > 0 )
  {
    ...
    {
      id_list[i].m_i = i;
      if ( ON_nil_uuid == id_list[i].m_uuid )
      {
        nil_count++;
        if ( text_log )
    ...
    if ( count > 1 )
    {
      ...
      for ( i = 1; i < count; i++ )
      {
        ...
        if ( id_list[i].m_uuid == id0.m_uuid )
        {
          dup_count++;
          if ( text_log )
    ...
    if ( index_list )
    {
      ...
      for ( i = 0; i < count; i++ )
      {
        index_list->AddUuidIndex(id_list[i].m_uuid,id_list[i].m_i,false);
      }
    }
  }
      ...
      )
{
  ...
  if ( count > 0 )
  {
    ...
    for ( i = 0; i < count; i++ )
    {
      id_list.AppendNew().m_uuid = model.m_object_table[i].m_attributes.m_uuid;
    }
    rc = AuditIdsHelper(
              id_list,
    ...
    if (rc && bAttemptRepair )
    {
      for ( i = 0; i < count; i++ )
      {
        model.m_object_table[id_list[i].m_i].m_attributes.m_uuid = id_list[i].m_uuid;
      }
    }
  }
  return rc;
      ...
      )
{
  ...
  if ( count > 0 )
  {
    ...
    for ( i = 0; i < count; i++ )
    {
      ...
      if ( ON_nil_uuid == light.m_light.m_light_id )
      {
        id_list.AppendNew().m_uuid = light.m_attributes.m_uuid;
      }
      else 
      {
        id_list.AppendNew().m_uuid = light.m_light.m_light_id;
      }
    }
    ...
    if ( rc && bAttemptRepair )
    {
      for ( i = 0; i < count; i++ )
      {
        ...
        light.m_light.m_light_id = id_list[i].m_uuid;
        light.m_attributes.m_uuid = light.m_light.m_light_id;
      }
    }
    ...
    for ( i = 0; i < count; i++ )
    {
      ...
      if ( model.m_object_id_index.FindUuid(light.m_light.m_light_id,&oi) )
      {
        ...
        if ( bAttemptRepair )
        {
          ...
          light_id.m_uuid = ON_nil_uuid;
          light_id.m_i = -1;
          if ( ON_CreateUuid(light_id.m_uuid) && ON_nil_uuid != light_id.m_uuid )
          {
            if (    !model.m_object_id_index.FindUuid(light_id.m_uuid) 
                 && id_list.BinarySearch( &light_id, ON_UuidIndex::CompareId ) < 0 
               )
            {
              if ( repair_count )
                *repair_count = *repair_count + 1;
              light.m_light.m_light_id = light_id.m_uuid;
              light.m_attributes.m_uuid = light.m_light.m_light_id;
              if ( text_log )
                text_log->Print(" Repaired.");
            }
      ...
      )
{
  ...
  if ( count > 0 )
  {
    ...
    for ( i = 0; i < count; i++ )
    {
      id_list.AppendNew().m_uuid = model.m_idef_table[i].m_uuid;
    }
    rc = AuditIdsHelper(
              id_list,
    ...
    if (rc && bAttemptRepair )
    {
      for ( i = 0; i < count; i++ )
      {
        model.m_idef_table[id_list[i].m_i].m_uuid = id_list[i].m_uuid;
      }
    }
  }
  return rc;
      ...
      )
{
  ...
  if ( count > 0 )
  {
    ...
    for ( i = 0; i < count; i++ )
    {
      id_list.AppendNew().m_uuid = model.m_mapping_table[i].m_mapping_id;
    }
    rc = AuditIdsHelper(
              id_list,
    ...
    if (rc && bAttemptRepair )
    {
      for ( i = 0; i < count; i++ )
      {
        model.m_mapping_table[id_list[i].m_i].m_mapping_id = id_list[i].m_uuid;
      }
    }
  }
  return rc;
      ...
      )
{
  ...
  if ( count > 0 )
  {
    ...
    for ( i = 0; i < count; i++ )
    {
      id_list.AppendNew().m_uuid = model.m_material_table[i].m_material_id;
    }
    rc = AuditIdsHelper(
              id_list,
    ...
    if (rc && bAttemptRepair )
    {
      for ( i = 0; i < count; i++ )
      {
        model.m_material_table[id_list[i].m_i].m_material_id = id_list[i].m_uuid;
      }
    }
  }
  return rc;
