/* $Header: /src4/opennurbs/opennurbs_math.cpp 22    6/09/06 10:55a Dalelear $ */
/* $NoKeywords: $ */
/*
//
...
const unsigned int* ON_BinarySearchUnsignedIntArray( int key, const unsigned int* base, size_t nel )
{
  if (nel > 0 && base )
  {
    size_t i;
