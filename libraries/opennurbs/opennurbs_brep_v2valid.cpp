/* $Header: /src4/opennurbs/opennurbs_brep_v2valid.cpp 5     7/24/06 2:06p Dalelear $ */
/* $NoKeywords: $ */
/*
//
  ...
  */
  ...
  for ( fli = 0; fli < face.m_li.Count(); fli++ )
  {
    ...
    for ( lti = 0; lti < loop_trim_count; lti++ )
    {
      ...
      if ( !nurbs_surface.GetLocalClosestPoint( pt[lti], uv0.x, uv0.y, &uv1.x, &uv1.y, NULL, NULL ) )
        break;
      nurbsuv.Append(uv1);
    }
