/* $Header: /src4/opennurbs/opennurbs_string.h 6     3/17/06 3:42p Dalelear $ */
/* $NoKeywords: $ */
/*
//
...
{
	long  ref_count;       // reference count (>=0 or -1 for empty string)
...
// Attributes & Operations
  ...
  */
  ...
  // remove occurrences of chRemove
	int Remove( const wchar_t chRemove);
