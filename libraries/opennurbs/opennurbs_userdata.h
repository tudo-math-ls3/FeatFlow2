/* $Header: /src4/opennurbs/opennurbs_userdata.h 6     12/13/04 1:36p Dalelear $ */
/* $NoKeywords: $ */
/*
//
...
public:
  ...
  */
  ...
  Description:
    ...
    YOU MUST READ AND UNDERSTAND EVERY COMMENT IN THIS HEADER 
    FILE IN BEFORE ATTEMPTING TO USE ON_UserData.
  ...
  */
  virtual 
  BOOL GetDescription( ON_wString& description ) = 0;

  /*
  Description:
    User will persist in binary archives if Archive() returns
    TRUE and the virtual Read() and Write() are functions
    are overridden.
  ...
  Remarks:
    ...
    ON_UserData::Archive, then you MUST override the virtual
    ON_Object::Read and ON_Object::Write functions and CAREFULLY
    TEST your code.
  */
  virtual 
  BOOL Archive() const; 
