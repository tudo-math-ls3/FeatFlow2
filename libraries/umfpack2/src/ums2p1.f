...
C-----------------------------------------------------------------------
        ...
        IF (WHO .EQ. 1) THEN 
           IF (WHERE .EQ. 1) THEN 
              WRITE (IO, 6) 'UMS2FA input:'
              PRLU = .FALSE.
           ELSE 
              WRITE (IO, 6) 'UMS2FA output:'
              PRLU = .TRUE.
           ENDIF 
        ELSE IF (WHO .EQ. 2) THEN 
           IF (WHERE .EQ. 1) THEN 
              WRITE (IO, 6) 'UMS2RF input:'
              PRLU = .TRUE.
           ELSE 
              WRITE (IO, 6) 'UMS2RF output:'
              PRLU = .TRUE.
           ENDIF 
        ELSE IF (WHO .EQ. 3) THEN 
           IF (WHERE .EQ. 1) THEN 
              WRITE (IO, 6) 'UMS2SO input:'
              PRLU = .TRUE.
           ELSE 
              WRITE (IO, 6) 'UMS2SO output:'
              PRLU = .FALSE.
           ENDIF 
        ENDIF 
...
C-----------------------------------------------------------------------
     ...
     $        ' : memory needed in INDEX for next call to UMS2RF'
              WRITE (IO, 1) '   INFO (23): ', INFO (23),
     $        ' : memory needed in VALUE for next call to UMS2RF'
           ELSE 
...
C          -------------------------------------------------------------
     ...
     $           ' ... KEEP (5): ', LUI2,' )'
                 WRITE (IO, 1) '   and for calls to UMS2RF: '
              ENDIF 
...
C-----------------------------------------------------------------------
        ...
        IF (WHO .EQ. 1) THEN 
           IF (WHERE .EQ. 1) THEN 
              WRITE (IO, 6) 'end of UMS2FA input '
           ELSE 
              WRITE (IO, 6) 'end of UMS2FA output'
           ENDIF 
        ELSE IF (WHO .EQ. 2) THEN 
           IF (WHERE .EQ. 1) THEN 
              WRITE (IO, 6) 'end of UMS2RF input '
           ELSE 
              WRITE (IO, 6) 'end of UMS2RF output'
           ENDIF 
        ELSE IF (WHO .EQ. 3) THEN 
           IF (WHERE .EQ. 1) THEN 
              WRITE (IO, 6) 'end of UMS2SO input '
           ELSE 
              WRITE (IO, 6) 'end of UMS2SO output'
           ENDIF 
        ENDIF 
