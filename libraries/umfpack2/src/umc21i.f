        SUBROUTINE UMC21I (KEEP, CNTL, ICNTL)
...
C  called once prior to any call to UMC2FA.
C
...
C               used in UMC2S2 to compute the sparse backward error
...
C
C  Keep (1 ... 5):  unmodified (see UMC2FA or UMC2RF for a description).
C
...
C## End of user documentation for UMC21I ###############################
