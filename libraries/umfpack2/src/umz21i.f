        SUBROUTINE UMZ21I (KEEP, CNTL, ICNTL)
...
C  called once prior to any call to UMZ2FA.
C
...
C               used in UMZ2S2 to compute the sparse backward error
...
C
C  Keep (1 ... 5):  unmodified (see UMZ2FA or UMZ2RF for a description).
C
...
C## End of user documentation for UMZ21I ###############################
