...
*          (multigrid version)                                         *
*          Successive call of XAB17                                    *
*                                                                      *
* Subroutines/functions called  XAB17                                  *
*                                                                      *
* Version from  06/04/93                                               *
*                                                                      *
* INPUT    TYPE                                                        *
* -----    ----                                                        *
...
* BSNGL    L*4    no meaning here                                      *
* Meshes on COMMON /MGTRD/ and /MGTRA/                                 *
*                                                                      *
* OUTPUT   TYPE                                                        *
* ------   ----                                                        *
* KLA      I*4    NBLOC*NLEV numbers of arrays on VA                   *
*                                                                      *
************************************************************************
C
      SUBROUTINE XMAB17(KLA,KLCOL,KLLD,KNA,KNEQ,NBLCA,ICLR,ELE,
...
C
      SUB='XMAB17'
      IF (ICHECK.GE.997) CALL OTRC('XMAB17','06/04/93')
      IER=0
C
C
...
C
      ...
      LABD   =KLABD(ILEV) 
C
      CALL XAB17(KLA(1,ILEV),KLCOL(ILEV),KLLD(ILEV),KNA(ILEV),
