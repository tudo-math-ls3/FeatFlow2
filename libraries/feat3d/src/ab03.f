...
*          Call of AB03                                                *
*                                                                      *
* Subroutines/functions called  AB03, ZNEW, ZDISP, ZLEN, ZTYPE, ZCLEAR *
*                                                                      *
* Version from  12/07/90                                               *
*                                                                      *
* INPUT    TYPE                                                        *
* -----    ----                                                        *
...
* For the description of the remaining parameters see AB03             *
*                                                                      *
* OUTPUT   TYPE                                                        *
* ------   ----                                                        *
...
* KDIAS    I*4    to storage technique 3/4 (calculated by AP3)         *
* NDIA     I*4    Number of diagonal rows per matrix                   *
...
C
      SUB='XAB03'
      IF (ICHECK.GE.997) CALL OTRC('XAB03 ','12/07/90')
      IER=0
C
      DO 1 IBLOC=1,NBLOC
...
3     CONTINUE
C
      CALL AB03(DWORK(1),KWORK(L(LDIA)),KWORK(L(LDIAS)),NDIA,NA,NEQ,
...
C
     ...
     *           NNAB=21,NNDIM=3)
      ...
      DIMENSION KOFF(*),KDFG(NNBAS),KDFL(NNBAS),DCORVG(3,*)
...
C
      SUB='AB03'
      IF (ICHECK.GE.997) CALL OTRC('AB03  ','12/07/90')
C
