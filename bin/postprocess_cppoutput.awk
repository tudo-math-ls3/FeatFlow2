...
#
# Task 2:
# 'cpp -CC' on CentOS 7 and other distriubitions based on a more recent
# GCC compiler unconditionally include the contents of stdc-predef.h
# in the output, i.e. unconditionally insert several C-style multiline
# comment blocks in the output. While the gfortran compiler can handle
# that, other compilers (like Intel Fortran compiler) can not and bail
# out. Get rid of those lines, too.
#
# Known drawbacks:
