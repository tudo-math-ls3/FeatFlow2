/* $Header: /src3/opennurbs/opennurbs_3dm_properties.cpp 1     7/25/01 2:14p Dalelear $ */
/* $NoKeywords: $ */
/*
//
...
ON_3dmRevisionHistory::ON_3dmRevisionHistory( const ON_3dmRevisionHistory& src ) : m_revision_count(0)
{
  memset( &m_create_time, 0, sizeof(&m_create_time) );
  memset( &m_last_edit_time, 0, sizeof(&m_last_edit_time) );
  *this = src;
...
ON_3dmRevisionHistory& ON_3dmRevisionHistory::operator=( const ON_3dmRevisionHistory& src )
{
  if ( this != &src ) {
    m_sCreatedBy     = src.m_sCreatedBy;
    m_sLastEditedBy  = src.m_sLastEditedBy;
    m_create_time    = src.m_create_time;
    m_last_edit_time = src.m_last_edit_time;
    m_revision_count = src.m_revision_count;
  }
  return *this;
}
