/* $Header: /src4/opennurbs/opennurbs_bezier.cpp 31    9/01/06 11:33a Dalelear $ */
/* $NoKeywords: $ */
/*
//
...
ON_BezierCurve::ON_BezierCurve()
               : m_dim(0), m_is_rat(0), m_order(0), 
                 m_cv_stride(0), m_cv_capacity(0), m_cv(0) //, m_domain(0.0,1.0)
{}
...
ON_BezierCurve::ON_BezierCurve(const ON_2dPointArray& cv)
               : m_dim(0), m_is_rat(0), m_order(0), 
                 m_cv_stride(0), m_cv_capacity(0), m_cv(0)
{
  *this = cv;
}
