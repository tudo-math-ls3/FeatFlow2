/* $Header: /src4/opennurbs/opennurbs_defines.h 39    9/06/06 11:10a Dalelear $ */
/* $NoKeywords: $ */
/*
//
...
public:
  ...
  */
	...
	enum object_material_source
  {
    ...
    material_from_parent = 3  // for objects with parents (like objects in instance references, use parent material)
                              // if not parent, treat as material_from_layer.
  };
