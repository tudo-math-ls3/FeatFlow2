/* $Header: /src4/opennurbs/opennurbs_3dm_settings.h 24    9/05/06 11:32a Dalelear $ */
/* $NoKeywords: $ */
/*
//
...
public:
  ...
  // clipping planes
  ON_SimpleArray<ON_ClippingPlane> m_clipping_planes;
...
public:
  ...
  int m_background_style; // 0 = solid color, 1 = "wallpaper" image
