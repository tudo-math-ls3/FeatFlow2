/* $Header: /src4/opennurbs/opennurbs_wstring.cpp 9     8/24/06 10:56a Dalelear $ */
/* $NoKeywords: $ */
/*
//
...
int ON_wString::Remove( const wchar_t chRemove)
{
  CopyArray();

  wchar_t* pstrSource = m_s;
  wchar_t* pstrDest = m_s;
  wchar_t* pstrEnd = m_s + Length();
