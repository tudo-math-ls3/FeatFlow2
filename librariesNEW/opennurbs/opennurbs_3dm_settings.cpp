/* $Header: /src4/opennurbs/opennurbs_3dm_settings.cpp 27    8/24/06 3:02p Dalelear $ */
/* $NoKeywords: $ */
/*
//
...
void ON_3dmView::Default()
{
  ...
  //memset(&m_parent_viewport_id,0,sizeof(m_parent_viewport_id));
  //memset(&m_nested_view_position,0,sizeof(m_nested_view_position));
}
