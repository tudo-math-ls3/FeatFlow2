...
#endif
#define VELMAGNITUDE1_2D(U,IDX)              (sqrt(POW(XVELOCITY1(U,IDX),2)+MYNEWLINE POW(YVELOCITY1(U,IDX),2)))
#define VELMAGNITUDE2_2D(U,IDX,i,n1,n2)      (sqrt(POW(XVELOCITY2(U,IDX,i,n1,n2),2)+MYNEWLINE POW(YVELOCITY2(U,IDX,i,n1,n2),2)))
#define VELMAGNITUDE3_2D(U,IDX,i,j,n1,n2,n3) (sqrt(POW(XVELOCITY3(U,IDX,i,j,n1,n2,n3),2)+MYNEWLINE POW(YVELOCITY3(U,IDX,i,j,n1,n2,n3),2)))

#if 0
! Compute magnitude of velocity field in 3D
#endif
#define VELMAGNITUDE1_3D(U,IDX)              (sqrt(POW(XVELOCITY1(U,IDX),2)+MYNEWLINE POW(YVELOCITY1(U,IDX),2)+MYNEWLINE POW(ZVELOCITY1(U,IDX),2)))
#define VELMAGNITUDE2_3D(U,IDX,i,n1,n2)      (sqrt(POW(XVELOCITY2(U,IDX,i,n1,n2),2)+MYNEWLINE POW(YVELOCITY2(U,IDX,i,n1,n2),2)+MYNEWLINE POW(ZVELOCITY2(U,IDX,i,n1,n2),2)))
#define VELMAGNITUDE3_3D(U,IDX,i,j,n1,n2,n3) (sqrt(POW(XVELOCITY3(U,IDX,i,j,n1,n2,n3),2)+MYNEWLINE POW(YVELOCITY3(U,IDX,i,j,n1,n2,n3),2)+MYNEWLINE POW(ZVELOCITY3(U,IDX,i,j,n1,n2,n3),2)))
...
#endif
#define PRESSURE1_1D(U,IDX)              (((RCONST(THERMODYN_GAMMA))-RCONST(1.0))*INTERNALENERGY1_1D(U,IDX))
#define PRESSURE2_1D(U,IDX,i,n1,n2)      (((RCONST(THERMODYN_GAMMA))-RCONST(1.0))*INTERNALENERGY2_1D(U,IDX,i,n1,n2))
#define PRESSURE3_1D(U,IDX,i,j,n1,n2,n3) (((RCONST(THERMODYN_GAMMA))-RCONST(1.0))*INTERNALENERGY3_1D(U,IDX,i,j,n1,n2,n3))

#if 0
! Compute pressure from conservative variables in 2D
#endif
#define PRESSURE1_2D(U,IDX)              (((RCONST(THERMODYN_GAMMA))-RCONST(1.0))*INTERNALENERGY1_2D(U,IDX))
#define PRESSURE2_2D(U,IDX,i,n1,n2)      (((RCONST(THERMODYN_GAMMA))-RCONST(1.0))*INTERNALENERGY2_2D(U,IDX,i,n1,n2))
#define PRESSURE3_2D(U,IDX,i,j,n1,n2,n3) (((RCONST(THERMODYN_GAMMA))-RCONST(1.0))*INTERNALENERGY3_2D(U,IDX,i,j,n1,n2,n3))

#if 0
! Compute pressure from conservative variables in 3D
#endif
#define PRESSURE1_3D(U,IDX)              (((RCONST(THERMODYN_GAMMA))-RCONST(1.0))*INTERNALENERGY1_3D(U,IDX))
#define PRESSURE2_3D(U,IDX,i,n1,n2)      (((RCONST(THERMODYN_GAMMA))-RCONST(1.0))*INTERNALENERGY2_3D(U,IDX,i,n1,n2))
#define PRESSURE3_3D(U,IDX,i,j,n1,n2,n3) (((RCONST(THERMODYN_GAMMA))-RCONST(1.0))*INTERNALENERGY3_3D(U,IDX,i,j,n1,n2,n3))
...
#endif
#define KINETICENERGY1_1D(U,IDX)              (RCONST(0.5)*(POW(XMOMENTUM1(U,IDX),2))/MYNEWLINE DENSITY1(U,IDX))
#define KINETICENERGY2_1D(U,IDX,i,n1,n2)      (RCONST(0.5)*(POW(XMOMENTUM2(U,IDX,i,n1,n2),2))/MYNEWLINE DENSITY2(U,IDX,i,n1,n2))
#define KINETICENERGY3_1D(U,IDX,i,j,n1,n2,n3) (RCONST(0.5)*(POW(XMOMENTUM3(U,IDX,i,j,n1,n2,n3),2))/MYNEWLINE DENSITY3(U,IDX,i,j,n1,n2,n3))

#if 0
! Compute kinetic energy from conservative variables in 2D
#endif
#define KINETICENERGY1_2D(U,IDX)              (RCONST(0.5)*(POW(XMOMENTUM1(U,IDX),2)+MYNEWLINE POW(YMOMENTUM1(U,IDX),2))/MYNEWLINE DENSITY1(U,IDX))
#define KINETICENERGY2_2D(U,IDX,i,n1,n2)      (RCONST(0.5)*(POW(XMOMENTUM2(U,IDX,i,n1,n2),2)+MYNEWLINE POW(YMOMENTUM2(U,IDX,i,n1,n2),2))/MYNEWLINE DENSITY2(U,IDX,i,n1,n2))
#define KINETICENERGY3_2D(U,IDX,i,j,n1,n2,n3) (RCONST(0.5)*(POW(XMOMENTUM3(U,IDX,i,j,n1,n2,n3),2)+MYNEWLINE POW(YMOMENTUM3(U,IDX,i,j,n1,n2,n3),2))/MYNEWLINE DENSITY3(U,IDX,i,j,n1,n2,n3))

#if 0
! Compute kinetic energy from conservative variables in 3D
#endif
#define KINETICENERGY1_3D(U,IDX)              (RCONST(0.5)*(POW(XMOMENTUM1(U,IDX),2)+MYNEWLINE POW(YMOMENTUM1(U,IDX),2)+MYNEWLINE POW(ZMOMENTUM1(U,IDX),2))/MYNEWLINE DENSITY1(U,IDX))
#define KINETICENERGY2_3D(U,IDX,i,n1,n2)      (RCONST(0.5)*(POW(XMOMENTUM2(U,IDX,i,n1,n2),2)+MYNEWLINE POW(YMOMENTUM2(U,IDX,i,n1,n2),2)+MYNEWLINE POW(ZMOMENTUM2(U,IDX,i,n1,n2),2))/MYNEWLINE DENSITY2(U,IDX,i,n1,n2))
#define KINETICENERGY3_3D(U,IDX,i,j,n1,n2,n3) (RCONST(0.5)*(POW(XMOMENTUM3(U,IDX,i,j,n1,n2,n3),2)+MYNEWLINE POW(YMOMENTUM3(U,IDX,i,j,n1,n2,n3),2)+MYNEWLINE POW(ZMOMENTUM3(U,IDX,i,j,n1,n2,n3),2))/MYNEWLINE DENSITY3(U,IDX,i,j,n1,n2,n3))
...
#endif
#define SOUNDSPEED1_1D(U,IDX)              (sqrt((RCONST(THERMODYN_GAMMA))*MYNEWLINE PRESSURE1_1D(U,IDX)/MYNEWLINE DENSITY1(U,IDX)))
#define SOUNDSPEED2_1D(U,IDX,i,n1,n2)      (sqrt((RCONST(THERMODYN_GAMMA))*MYNEWLINE PRESSURE2_1D(U,IDX,i,n1,n2)/MYNEWLINE DENSITY2(U,IDX,i,n1,n2)))
#define SOUNDSPEED3_1D(U,IDX,i,j,n1,n2,n3) (sqrt((RCONST(THERMODYN_GAMMA))*MYNEWLINE PRESSURE3_1D(U,IDX,i,j,n1,n2,n3)/MYNEWLINE DENSITY3(U,IDX,i,j,n1,n2,n3)))

#if 0
! Compute speed of sound for a thermally perfect gas in 2D
#endif
#define SOUNDSPEED1_2D(U,IDX)              (sqrt((RCONST(THERMODYN_GAMMA))*MYNEWLINE PRESSURE1_2D(U,IDX)/MYNEWLINE DENSITY1(U,IDX)))
#define SOUNDSPEED2_2D(U,IDX,i,n1,n2)      (sqrt((RCONST(THERMODYN_GAMMA))*MYNEWLINE PRESSURE2_2D(U,IDX,i,n1,n2)/MYNEWLINE DENSITY2(U,IDX,i,n1,n2)))
#define SOUNDSPEED3_2D(U,IDX,i,j,n1,n2,n3) (sqrt((RCONST(THERMODYN_GAMMA))*MYNEWLINE PRESSURE3_2D(U,IDX,i,j,n1,n2,n3)/MYNEWLINE DENSITY3(U,IDX,i,j,n1,n2,n3)))

#if 0
! Compute speed of sound for a thermally perfect gas in 3D
#endif
#define SOUNDSPEED1_3D(U,IDX)              (sqrt((RCONST(THERMODYN_GAMMA))*MYNEWLINE PRESSURE1_3D(U,IDX)/MYNEWLINE DENSITY1(U,IDX)))
#define SOUNDSPEED2_3D(U,IDX,i,n1,n2)      (sqrt((RCONST(THERMODYN_GAMMA))*MYNEWLINE PRESSURE2_3D(U,IDX,i,n1,n2)/MYNEWLINE DENSITY2(U,IDX,i,n1,n2)))
#define SOUNDSPEED3_3D(U,IDX,i,j,n1,n2,n3) (sqrt((RCONST(THERMODYN_GAMMA))*MYNEWLINE PRESSURE3_3D(U,IDX,i,j,n1,n2,n3)/MYNEWLINE DENSITY3(U,IDX,i,j,n1,n2,n3)))
...
#endif
#define MACHNUMBER1_2D(U,IDX)              (sqrt(POW(XVELOCITY1(U,IDX),2)+MYNEWLINE POW(YVELOCITY1(U,IDX),2))/MYNEWLINE	SOUNDSPEED1_2D(U,IDX))
#define MACHNUMBER2_2D(U,IDX,i,n1,n2)      (sqrt(POW(XVELOCITY2(U,IDX,i,n1,n2),2)+MYNEWLINE POW(YVELOCITY2(U,IDX,i,n1,n2),2))/MYNEWLINE	SOUNDSPEED2_2D(U,IDX,i,n1,n2))
#define MACHNUMBER3_2D(U,IDX,i,j,n1,n2,n3) (sqrt(XVELOCITY3(U,IDX,i,j,n1,n2,n3)+MYNEWLINE POW(YVELOCITY3(U,IDX,i,j,n1,n2,n3),2))/MYNEWLINE SOUNDSPEED3_2D(U,IDX,i,j,n1,n2,n3))

#if 0
! Compute the Mach number in 3D
#endif
#define MACHNUMBER1_3D(U,IDX)              (sqrt(POW(XVELOCITY1(U,IDX),2)+MYNEWLINE POW(YVELOCITY1(U,IDX),2)+MYNEWLINE POW(ZVELOCITY1(U,IDX),2))/MYNEWLINE	SOUNDSPEED1_3D(U,IDX))
#define MACHNUMBER2_3D(U,IDX,i,n1,n2)      (sqrt(POW(XVELOCITY2(U,IDX,i,n1,n2),2)+MYNEWLINE POW(YVELOCITY2(U,IDX,i,n1,n2),2)+MYNEWLINE POW(ZVELOCITY2(U,IDX,i,n1,n2),2))/MYNEWLINE SOUNDSPEED2_3D(U,IDX,i,n1,n2))
#define MACHNUMBER3_3D(U,IDX,i,j,n1,n2,n3) (sqrt(POW(XVELOCITY3(U,IDX,i,j,n1,n2,n3),2)+MYNEWLINE POW(YVELOCITY3(U,IDX,i,j,n1,n2,n3),2)+MYNEWLINE POW(ZVELOCITY3(U,IDX,i,j,n1,n2,n3),2))/MYNEWLINE SOUNDSPEED3_3D(U,IDX,i,j,n1,n2,n3))
