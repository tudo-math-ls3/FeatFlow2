...
#endif
#define KINETICENERGY1_1D(U,IDX)              (RCONST(0.5)*(POW(XMOMENTUM1_1D(U,IDX),2))/MYNEWLINE DENSITY1_1D(U,IDX))
#define KINETICENERGY2_1D(U,IDX,i,n1,n2)      (RCONST(0.5)*(POW(XMOMENTUM2_1D(U,IDX,i,n1,n2),2))/MYNEWLINE DENSITY2_1D(U,IDX,i,n1,n2))
#define KINETICENERGY3_1D(U,IDX,i,j,n1,n2,n3) (RCONST(0.5)*(POW(XMOMENTUM3_1D(U,IDX,i,j,n1,n2,n3),2))/MYNEWLINE DENSITY3_1D(U,IDX,i,j,n1,n2,n3))

#if 0
! Compute kinetic energy from conservative variables in 2D
#endif
#define KINETICENERGY1_2D(U,IDX)              (RCONST(0.5)*(POW(XMOMENTUM1_2D(U,IDX),2)+MYNEWLINE POW(YMOMENTUM1_2D(U,IDX),2))/MYNEWLINE DENSITY1_2D(U,IDX))
#define KINETICENERGY2_2D(U,IDX,i,n1,n2)      (RCONST(0.5)*(POW(XMOMENTUM2_2D(U,IDX,i,n1,n2),2)+MYNEWLINE POW(YMOMENTUM2_2D(U,IDX,i,n1,n2),2))/MYNEWLINE DENSITY2_2D(U,IDX,i,n1,n2))
#define KINETICENERGY3_2D(U,IDX,i,j,n1,n2,n3) (RCONST(0.5)*(POW(XMOMENTUM3_2D(U,IDX,i,j,n1,n2,n3),2)+MYNEWLINE POW(YMOMENTUM3_2D(U,IDX,i,j,n1,n2,n3),2))/MYNEWLINE DENSITY3_2D(U,IDX,i,j,n1,n2,n3))

#if 0
! Compute kinetic energy from conservative variables in 3D
#endif
#define KINETICENERGY1_3D(U,IDX)              (RCONST(0.5)*(POW(XMOMENTUM1_3D(U,IDX),2)+MYNEWLINE POW(YMOMENTUM1_3D(U,IDX),2)+MYNEWLINE POW(ZMOMENTUM1_3D(U,IDX),2))/MYNEWLINE DENSITY1_3D(U,IDX))
#define KINETICENERGY2_3D(U,IDX,i,n1,n2)      (RCONST(0.5)*(POW(XMOMENTUM2_3D(U,IDX,i,n1,n2),2)+MYNEWLINE POW(YMOMENTUM2_3D(U,IDX,i,n1,n2),2)+MYNEWLINE POW(ZMOMENTUM2_3D(U,IDX,i,n1,n2),2))/MYNEWLINE DENSITY2_3D(U,IDX,i,n1,n2))
#define KINETICENERGY3_3D(U,IDX,i,j,n1,n2,n3) (RCONST(0.5)*(POW(XMOMENTUM3_3D(U,IDX,i,j,n1,n2,n3),2)+MYNEWLINE POW(YMOMENTUM3_3D(U,IDX,i,j,n1,n2,n3),2)+MYNEWLINE POW(ZMOMENTUM3_3D(U,IDX,i,j,n1,n2,n3),2))/MYNEWLINE DENSITY3_3D(U,IDX,i,j,n1,n2,n3))
...
#endif
#define SOUNDSPEED1_1D(U,IDX)              (sqrt((RCONST(THERMODYN_GAMMA))*MYNEWLINE PRESSURE1_1D(U,IDX)/MYNEWLINE DENSITY1_1D(U,IDX)))
#define SOUNDSPEED2_1D(U,IDX,i,n1,n2)      (sqrt((RCONST(THERMODYN_GAMMA))*MYNEWLINE PRESSURE2_1D(U,IDX,i,n1,n2)/MYNEWLINE DENSITY2_1D(U,IDX,i,n1,n2)))
#define SOUNDSPEED3_1D(U,IDX,i,j,n1,n2,n3) (sqrt((RCONST(THERMODYN_GAMMA))*MYNEWLINE PRESSURE3_1D(U,IDX,i,j,n1,n2,n3)/MYNEWLINE DENSITY3_1D(U,IDX,i,j,n1,n2,n3)))

#if 0
! Compute speed of sound for a thermally perfect gas in 2D
#endif
#define SOUNDSPEED1_2D(U,IDX)              (sqrt((RCONST(THERMODYN_GAMMA))*MYNEWLINE PRESSURE1_2D(U,IDX)/MYNEWLINE DENSITY1_2D(U,IDX)))
#define SOUNDSPEED2_2D(U,IDX,i,n1,n2)      (sqrt((RCONST(THERMODYN_GAMMA))*MYNEWLINE PRESSURE2_2D(U,IDX,i,n1,n2)/MYNEWLINE DENSITY2_2D(U,IDX,i,n1,n2)))
#define SOUNDSPEED3_2D(U,IDX,i,j,n1,n2,n3) (sqrt((RCONST(THERMODYN_GAMMA))*MYNEWLINE PRESSURE3_2D(U,IDX,i,j,n1,n2,n3)/MYNEWLINE DENSITY3_2D(U,IDX,i,j,n1,n2,n3)))

#if 0
! Compute speed of sound for a thermally perfect gas in 3D
#endif
#define SOUNDSPEED1_3D(U,IDX)              (sqrt((RCONST(THERMODYN_GAMMA))*MYNEWLINE PRESSURE1_3D(U,IDX)/MYNEWLINE DENSITY1_3D(U,IDX)))
#define SOUNDSPEED2_3D(U,IDX,i,n1,n2)      (sqrt((RCONST(THERMODYN_GAMMA))*MYNEWLINE PRESSURE2_3D(U,IDX,i,n1,n2)/MYNEWLINE DENSITY2_3D(U,IDX,i,n1,n2)))
#define SOUNDSPEED3_3D(U,IDX,i,j,n1,n2,n3) (sqrt((RCONST(THERMODYN_GAMMA))*MYNEWLINE PRESSURE3_3D(U,IDX,i,j,n1,n2,n3)/MYNEWLINE DENSITY3_3D(U,IDX,i,j,n1,n2,n3)))
