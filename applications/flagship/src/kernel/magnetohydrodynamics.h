...
#endif
#define PRESSURE1_1D(U,IDX)              (((RCONST(MAGNETOHYDRODYN_GAMMA))-RCONST(1.0))*INTERNALENERGY1_1D(U,IDX))
#define PRESSURE2_1D(U,IDX,i,n1,n2)      (((RCONST(MAGNETOHYDRODYN_GAMMA))-RCONST(1.0))*INTERNALENERGY2_1D(U,IDX,i,n1,n2))
#define PRESSURE3_1D(U,IDX,i,j,n1,n2,n3) (((RCONST(MAGNETOHYDRODYN_GAMMA))-RCONST(1.0))*INTERNALENERGY3_1D(U,IDX,i,j,n1,n2,n3))

#define PRESSURE1_2D(U,IDX)              (((RCONST(MAGNETOHYDRODYN_GAMMA))-RCONST(1.0))*INTERNALENERGY1_2D(U,IDX))
#define PRESSURE2_2D(U,IDX,i,n1,n2)      (((RCONST(MAGNETOHYDRODYN_GAMMA))-RCONST(1.0))*INTERNALENERGY2_2D(U,IDX,i,n1,n2))
#define PRESSURE3_2D(U,IDX,i,j,n1,n2,n3) (((RCONST(MAGNETOHYDRODYN_GAMMA))-RCONST(1.0))*INTERNALENERGY3_2D(U,IDX,i,j,n1,n2,n3))

#define PRESSURE1_3D(U,IDX)              (((RCONST(MAGNETOHYDRODYN_GAMMA))-RCONST(1.0))*INTERNALENERGY1_3D(U,IDX))
#define PRESSURE2_3D(U,IDX,i,n1,n2)      (((RCONST(MAGNETOHYDRODYN_GAMMA))-RCONST(1.0))*INTERNALENERGY2_3D(U,IDX,i,n1,n2))
#define PRESSURE3_3D(U,IDX,i,j,n1,n2,n3) (((RCONST(MAGNETOHYDRODYN_GAMMA))-RCONST(1.0))*INTERNALENERGY3_3D(U,IDX,i,j,n1,n2,n3))
...
#endif
#define KINETICENERGY1_1D(U,IDX)              (RCONST(0.5)*(POW(XMOMENTUM1_1D(U,IDX),2)+MYNEWLINE POW(YMOMENTUM1_1D(U,IDX),2)+MYNEWLINE POW(ZMOMENTUM1_1D(U,IDX),2))/MYNEWLINE DENSITY1_1D(U,IDX))
#define KINETICENERGY2_1D(U,IDX,i,n1,n2)      (RCONST(0.5)*(POW(XMOMENTUM2_1D(U,IDX,i,n1,n2),2)+MYNEWLINE POW(YMOMENTUM2_1D(U,IDX,i,n1,n2),2)+MYNEWLINE POW(ZMOMENTUM2_1D(U,IDX,i,n1,n2),2))/MYNEWLINE DENSITY2_1D(U,IDX,i,n1,n2))
#define KINETICENERGY3_1D(U,IDX,i,j,n1,n2,n3) (RCONST(0.5)*(POW(XMOMENTUM3_1D(U,IDX,i,j,n1,n2,n3),2)+MYNEWLINE POW(YMOMENTUM3_1D(U,IDX,i,j,n1,n2,n3),2)+MYNEWLINE POW(ZMOMENTUM3_1D(U,IDX,i,j,n1,n2,n3),2))/MYNEWLINE DENSITY3_1D(U,IDX,i,j,n1,n2,n3))

#define KINETICENERGY1_2D(U,IDX)              (RCONST(0.5)*(POW(XMOMENTUM1_2D(U,IDX),2)+MYNEWLINE POW(YMOMENTUM1_2D(U,IDX),2)+MYNEWLINE POW(ZMOMENTUM1_2D(U,IDX),2))/MYNEWLINE DENSITY1_2D(U,IDX))
#define KINETICENERGY2_2D(U,IDX,i,n1,n2)      (RCONST(0.5)*(POW(XMOMENTUM2_2D(U,IDX,i,n1,n2),2)+MYNEWLINE POW(YMOMENTUM2_2D(U,IDX,i,n1,n2),2)+MYNEWLINE POW(ZMOMENTUM2_2D(U,IDX,i,n1,n2),2))/MYNEWLINE DENSITY2_2D(U,IDX,i,n1,n2))
#define KINETICENERGY3_2D(U,IDX,i,j,n1,n2,n3) (RCONST(0.5)*(POW(XMOMENTUM3_2D(U,IDX,i,j,n1,n2,n3),2)+MYNEWLINE POW(YMOMENTUM3_2D(U,IDX,i,j,n1,n2,n3),2)+MYNEWLINE POW(ZMOMENTUM3_2D(U,IDX,i,j,n1,n2,n3),2))/MYNEWLINE DENSITY3_2D(U,IDX,i,j,n1,n2,n3))
...
#endif
#define MAGNETICENERGY1_1D(U,IDX)              (POW(XMAGFIELD1_1D(U,IDX),2)+MYNEWLINE POW(YMAGFIELD1_1D(U,IDX),2)+MYNEWLINE POW(ZMAGFIELD1_1D(U,IDX),2))/(RCONST(2.0)*MAGNETOHYDRODYN_VACUUM_PERM)
#define MAGNETICENERGY2_1D(U,IDX,i,n1,n2)      (POW(XMAGFIELD2_1D(U,IDX,i,n1,n2),2)+MYNEWLINE POW(YMAGFIELD2_1D(U,IDX,i,n1,n2),2)+MYNEWLINE POW(ZMAGFIELD2_1D(U,IDX,i,n1,n2),2))/(RCONST(2.0)*MAGNETOHYDRODYN_VACUUM_PERM)
#define MAGNETICENERGY3_1D(U,IDX,i,j,n1,n2,n3) (POW(XMAGFIELD3_1D(U,IDX,i,j,n1,n2,n3),2)+MYNEWLINE POW(YMAGFIELD3_1D(U,IDX,i,j,n1,n2,n3),2)+MYNEWLINE POW(ZMAGFIELD3_1D(U,IDX,i,j,n1,n2,n3),2))/(RCONST(2.0)*MAGNETOHYDRODYN_VACUUM_PERM)

#define MAGNETICENERGY1_2D(U,IDX)              (POW(XMAGFIELD1_2D(U,IDX),2)+MYNEWLINE POW(YMAGFIELD1_2D(U,IDX),2)+MYNEWLINE POW(ZMAGFIELD1_2D(U,IDX),2))/(RCONST(2.0)*MAGNETOHYDRODYN_VACUUM_PERM)
#define MAGNETICENERGY2_2D(U,IDX,i,n1,n2)      (POW(XMAGFIELD2_2D(U,IDX,i,n1,n2),2)+MYNEWLINE POW(YMAGFIELD2_2D(U,IDX,i,n1,n2),2)+MYNEWLINE POW(ZMAGFIELD2_2D(U,IDX,i,n1,n2),2))/(RCONST(2.0)*MAGNETOHYDRODYN_VACUUM_PERM)
#define MAGNETICENERGY3_2D(U,IDX,i,j,n1,n2,n3) (POW(XMAGFIELD3_2D(U,IDX,i,j,n1,n2,n3),2)+MYNEWLINE POW(YMAGFIELD3_2D(U,IDX,i,j,n1,n2,n3),2)+MYNEWLINE POW(ZMAGFIELD3_2D(U,IDX,i,j,n1,n2,n3),2))/(RCONST(2.0)*MAGNETOHYDRODYN_VACUUM_PERM)

#define MAGNETICENERGY1_3D(U,IDX)              (POW(XMAGFIELD1_3D(U,IDX),2)+MYNEWLINE POW(YMAGFIELD1_3D(U,IDX),2)+MYNEWLINE POW(ZMAGFIELD1_3D(U,IDX),2))/(RCONST(2.0)*MAGNETOHYDRODYN_VACUUM_PERM)
#define MAGNETICENERGY2_3D(U,IDX,i,n1,n2)      (POW(XMAGFIELD2_3D(U,IDX,i,n1,n2),2)+MYNEWLINE POW(YMAGFIELD2_3D(U,IDX,i,n1,n2),2)+MYNEWLINE POW(ZMAGFIELD2_3D(U,IDX,i,n1,n2),2))/(RCONST(2.0)*MAGNETOHYDRODYN_VACUUM_PERM)
#define MAGNETICENERGY3_3D(U,IDX,i,j,n1,n2,n3) (POW(XMAGFIELD3_3D(U,IDX,i,j,n1,n2,n3),2)+MYNEWLINE POW(YMAGFIELD3_3D(U,IDX,i,j,n1,n2,n3),2)+MYNEWLINE POW(ZMAGFIELD3_3D(U,IDX,i,j,n1,n2,n3),2))/(RCONST(2.0)*MAGNETOHYDRODYN_VACUUM_PERM)
...
#endif
#define SOUNDSPEED1_1D(U,IDX)              (sqrt((RCONST(MAGNETOHYDRODYN_GAMMA))*MYNEWLINE PRESSURE1_1D(U,IDX)/MYNEWLINE DENSITY1_1D(U,IDX)))
#define SOUNDSPEED2_1D(U,IDX,i,n1,n2)      (sqrt((RCONST(MAGNETOHYDRODYN_GAMMA))*MYNEWLINE PRESSURE2_1D(U,IDX,i,n1,n2)/MYNEWLINE DENSITY2_1D(U,IDX,i,n1,n2)))
#define SOUNDSPEED3_1D(U,IDX,i,j,n1,n2,n3) (sqrt((RCONST(MAGNETOHYDRODYN_GAMMA))*MYNEWLINE PRESSURE3_1D(U,IDX,i,j,n1,n2,n3)/MYNEWLINE DENSITY3_1D(U,IDX,i,j,n1,n2,n3)))

#define SOUNDSPEED1_2D(U,IDX)              (sqrt((RCONST(MAGNETOHYDRODYN_GAMMA))*MYNEWLINE PRESSURE1_2D(U,IDX)/MYNEWLINE DENSITY1_2D(U,IDX)))
#define SOUNDSPEED2_2D(U,IDX,i,n1,n2)      (sqrt((RCONST(MAGNETOHYDRODYN_GAMMA))*MYNEWLINE PRESSURE2_2D(U,IDX,i,n1,n2)/MYNEWLINE DENSITY2_2D(U,IDX,i,n1,n2)))
#define SOUNDSPEED3_2D(U,IDX,i,j,n1,n2,n3) (sqrt((RCONST(MAGNETOHYDRODYN_GAMMA))*MYNEWLINE PRESSURE3_2D(U,IDX,i,j,n1,n2,n3)/MYNEWLINE DENSITY3_2D(U,IDX,i,j,n1,n2,n3)))

#define SOUNDSPEED1_3D(U,IDX)              (sqrt((RCONST(MAGNETOHYDRODYN_GAMMA))*MYNEWLINE PRESSURE1_3D(U,IDX)/MYNEWLINE DENSITY1_3D(U,IDX)))
#define SOUNDSPEED2_3D(U,IDX,i,n1,n2)      (sqrt((RCONST(MAGNETOHYDRODYN_GAMMA))*MYNEWLINE PRESSURE2_3D(U,IDX,i,n1,n2)/MYNEWLINE DENSITY2_3D(U,IDX,i,n1,n2)))
#define SOUNDSPEED3_3D(U,IDX,i,j,n1,n2,n3) (sqrt((RCONST(MAGNETOHYDRODYN_GAMMA))*MYNEWLINE PRESSURE3_3D(U,IDX,i,j,n1,n2,n3)/MYNEWLINE DENSITY3_3D(U,IDX,i,j,n1,n2,n3)))
