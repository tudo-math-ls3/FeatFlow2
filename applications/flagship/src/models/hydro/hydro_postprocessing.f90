!##############################################################################
!# ****************************************************************************
!# <Name> hydro_postprocessing </name>
!# ****************************************************************************
!#
!# <purpose>
...
!</subroutine>
    ...
    if (iformatUCD .eq. 0) then
      call output_line('No valid output format is specified!',&
          OU_CLASS_WARNING,OU_MODE_STD,'hydro_outputSolution')
      return
    end if
...
!</subroutine>
    ...
    do iblock = 1, rdestVector%nblocks
      ...
      call linf_buildVectorScalar(rform, .true.,&
          ...
          fcoeff_buildVectorSc_sim=hydro_coeffVectorFE,&
