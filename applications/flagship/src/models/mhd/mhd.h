...
#define XMAGFIELD1_1D(U,IDX)                (RCONST(MHD_XMAGFIELD_CONST))
#define XMAGFIELD2_1D(U,IDX,i,n1,n2)        (RCONST(MHD_XMAGFIELD_CONST))
#define XMAGFIELD3_1D(U,IDX,i,j,n1,n2,n3)   (RCONST(MHD_XMAGFIELD_CONST))
...
#define MAG_DOT_VEL1_1D(U,IDX,u,v,w)              (XMAGFIELD1_1D(U,IDX)*u+ MYNEWLINE YMAGFIELD1_1D(U,IDX)*v+ MYNEWLINE ZMAGFIELD1_1D(U,IDX)*w)
#define MAG_DOT_VEL2_1D(U,IDX,i,n1,n2,u,v,w)      (XMAGFIELD2_1D(U,IDX,i,n1,n2)*u+ MYNEWLINE YMAGFIELD2_1D(U,IDX,i,n1,n2)*v+ MYNEWLINE ZMAGFIELD2_1D(U,IDX,i,n1,n2)*w)
#define MAG_DOT_VEL3_1D(U,IDX,i,j,n1,n2,n3,u,v,w) (XMAGFIELD3_1D(U,IDX,i,j,n1,n2,n3)*u+ MYNEWLINE YMAGFIELD3_1D(U,IDX,i,j,n1,n2,n3)*v+ MYNEWLINE ZMAGFIELD3_1D(U,IDX,i,j,n1,n2,n3)*w)

#define MAG_DOT_VEL1_2D(U,IDX,u,v,w)              (XMAGFIELD1_2D(U,IDX)*u+ MYNEWLINE YMAGFIELD1_2D(U,IDX)*v+ MYNEWLINE ZMAGFIELD1_2D(U,IDX)*w)
#define MAG_DOT_VEL2_2D(U,IDX,i,n1,n2,u,v,w)      (XMAGFIELD2_2D(U,IDX,i,n1,n2)*u+ MYNEWLINE YMAGFIELD2_2D(U,IDX,i,n1,n2)*v+ MYNEWLINE ZMAGFIELD2_2D(U,IDX,i,n1,n2)*w)
#define MAG_DOT_VEL3_2D(U,IDX,i,j,n1,n2,n3,u,v,w) (XMAGFIELD3_2D(U,IDX,i,j,n1,n2,n3)*u+ MYNEWLINE YMAGFIELD3_2D(U,IDX,i,j,n1,n2,n3)*v+ MYNEWLINE ZMAGFIELD3_2D(U,IDX,i,j,n1,n2,n3)*w)

#define MAG_DOT_VEL1_3D(U,IDX,u,v,w)              (XMAGFIELD1_3D(U,IDX)*u+ MYNEWLINE YMAGFIELD1_3D(U,IDX)*v+ MYNEWLINE ZMAGFIELD1_3D(U,IDX)*w)
#define MAG_DOT_VEL2_3D(U,IDX,i,n1,n2,u,v,w)      (XMAGFIELD2_3D(U,IDX,i,n1,n2)*u+ MYNEWLINE YMAGFIELD2_3D(U,IDX,i,n1,n2)*v+ MYNEWLINE ZMAGFIELD2_3D(U,IDX,i,n1,n2)*w)
#define MAG_DOT_VEL3_3D(U,IDX,i,j,n1,n2,n3,u,v,w) (XMAGFIELD3_3D(U,IDX,i,j,n1,n2,n3)*u+ MYNEWLINE YMAGFIELD3_3D(U,IDX,i,j,n1,n2,n3)*v+ MYNEWLINE ZMAGFIELD3_3D(U,IDX,i,j,n1,n2,n3)*w)
...
#define INVISCIDFLUX3_XDIR1_1D(U,IDX,u,v,w,p,q) (YMOMENTUM1_1D(U,IDX)*u-MYNEWLINE XMAGFIELD1_1D(U,IDX)* MYNEWLINE YMAGFIELD(U,IDX))
#define INVISCIDFLUX4_XDIR1_1D(U,IDX,u,v,w,p,q) (ZMOMENTUM1_1D(U,IDX)*u-MYNEWLINE XMAGFIELD1_1D(U,IDX)* MYNEWLINE ZMAGFIELD1_1D(U,IDX))
#define INVISCIDFLUX5_XDIR1_1D(U,IDX,u,v,w,p,q) (YMAGFIELD1_1D(U,IDX)*u-MYNEWLINE XMAGFIELD1_1D(U,IDX)*v)
#define INVISCIDFLUX6_XDIR1_1D(U,IDX,u,v,w,p,q) (ZMAGFIELD1_1D(U,IDX)*u-MYNEWLINE XMAGFIELD1_1D(U,IDX)*w)
#define INVISCIDFLUX7_XDIR1_1D(U,IDX,u,v,w,p,q) (TOTALENERGY1_1D(U,IDX)*u+p*u-MYNEWLINE XMAGFIELD1_1D(U,IDX)*q)
...
#define INVISCIDFLUX3_XDIR2_1D(U,IDX,i,n1,n2,u,v,w,p,q) (YMOMENTUM2_1D(U,IDX,i,n1,n2)*u-MYNEWLINE XMAGFIELD2_1D(U,IDX,i,n1,n2)* MYNEWLINE YMAGFIELD2_1D(U,IDX,i,n1,n2))
#define INVISCIDFLUX4_XDIR2_1D(U,IDX,i,n1,n2,u,v,w,p,q) (ZMOMENTUM2_1D(U,IDX,i,n1,n2)*u-MYNEWLINE XMAGFIELD2_1D(U,IDX,i,n1,n2)* MYNEWLINE ZMAGFIELD2_1D(U,IDX,i,n1,n2))
#define INVISCIDFLUX5_XDIR2_1D(U,IDX,i,n1,n2,u,v,w,p,q) (YMAGFIELD2_1D(U,IDX,i,n1,n2)*u-MYNEWLINE XMAGFIELD2_1D(U,IDX,i,n1,n2)*v)
#define INVISCIDFLUX6_XDIR2_1D(U,IDX,i,n1,n2,u,v,w,p,q) (ZMAGFIELD2_1D(U,IDX,i,n1,n2)*u-MYNEWLINE XMAGFIELD2_1D(U,IDX,i,n1,n2)*w)
#define INVISCIDFLUX7_XDIR2_1D(U,IDX,i,n1,n2,u,v,w,p,q) (TOTALENERGY2_1D(U,IDX,i,n1,n2)*u+p*u-MYNEWLINE XMAGFIELD2_1D(U,IDX,i,n1,n2)*q)
...
#define INVISCIDFLUX3_XDIR3_1D(U,IDX,i,j,n1,n2,n3,u,v,w,p,q) (YMOMENTUM3_1D(U,IDX,i,j,n1,n2,n3)*u-MYNEWLINE XMAGFIELD3_1D(U,IDX,i,j,n1,n2,n3)* MYNEWLINE YMAGFIELD3_1D(U,IDX,i,j,n1,n2,n3))
#define INVISCIDFLUX4_XDIR3_1D(U,IDX,i,j,n1,n2,n3,u,v,w,p,q) (ZMOMENTUM3_1D(U,IDX,i,j,n1,n2,n3)*u-MYNEWLINE XMAGFIELD3_1D(U,IDX,i,j,n1,n2,n3)* MYNEWLINE ZMAGFIELD3_1D(U,IDX,i,j,n1,n2,n3))
#define INVISCIDFLUX5_XDIR3_1D(U,IDX,i,j,n1,n2,n3,u,v,w,p,q) (YMAGFIELD3_1D(U,IDX,i,j,n1,n2,n3)*u-MYNEWLINE XMAGFIELD3_1D(U,IDX,i,j,n1,n2,n3)*v)
#define INVISCIDFLUX6_XDIR3_1D(U,IDX,i,j,n1,n2,n3,u,v,w,p,q) (ZMAGFIELD3_1D(U,IDX,i,j,n1,n2,n3)*u-MYNEWLINE XMAGFIELD3_1D(U,IDX,i,j,n1,n2,n3)*w)
#define INVISCIDFLUX7_XDIR3_1D(U,IDX,i,j,n1,n2,n3,u,v,w,p,q) (TOTALENERGY3_1D(U,IDX,i,j,n1,n2,n3)*u+p*u-MYNEWLINE XMAGFIELD3_1D(U,IDX,i,j,n1,n2,n3)*q)
...
#define INVISCIDFLUX2_XDIR1_2D(U,IDX,u,v,w,p,q) (XMOMENTUM1_2D(U,IDX)*u+p-MYNEWLINE POW(XMAGFIELD1_2D(U,IDX),2))
#define INVISCIDFLUX3_XDIR1_2D(U,IDX,u,v,w,p,q) (YMOMENTUM1_2D(U,IDX)*u-MYNEWLINE XMAGFIELD1_2D(U,IDX)* MYNEWLINE YMAGFIELD1_2D(U,IDX))
#define INVISCIDFLUX4_XDIR1_2D(U,IDX,u,v,w,p,q) (ZMOMENTUM1_2D(U,IDX)*u-MYNEWLINE XMAGFIELD1_2D(U,IDX)* MYNEWLINE ZMAGFIELD1_2D(U,IDX))
#define INVISCIDFLUX5_XDIR1_2D(U,IDX,u,v,w,p,q)  RCONST(0.0)
#define INVISCIDFLUX6_XDIR1_2D(U,IDX,u,v,w,p,q) (YMAGFIELD1_2D(U,IDX)*u-MYNEWLINE XMAGFIELD1_2D(U,IDX)*v)
#define INVISCIDFLUX7_XDIR1_2D(U,IDX,u,v,w,p,q) (ZMAGFIELD1_2D(U,IDX)*u-MYNEWLINE XMAGFIELD1_2D(U,IDX)*w)
#define INVISCIDFLUX8_XDIR1_2D(U,IDX,u,v,w,p,q) (TOTALENERGY1_2D(U,IDX)*u+p*u-MYNEWLINE XMAGFIELD1_2D(U,IDX)*q)

#define INVISCIDFLUX1_XDIR2_2D(U,IDX,i,n1,n2,u,v,w,p,q)  XMOMENTUM2_2D(U,IDX,i,n1,n2)
#define INVISCIDFLUX2_XDIR2_2D(U,IDX,i,n1,n2,u,v,w,p,q) (XMOMENTUM2_2D(U,IDX,i,n1,n2)*u+p-MYNEWLINE POW(XMAGFIELD2_2D(U,IDX,i,n1,n2),2))
#define INVISCIDFLUX3_XDIR2_2D(U,IDX,i,n1,n2,u,v,w,p,q) (YMOMENTUM2_2D(U,IDX,i,n1,n2)*u-MYNEWLINE XMAGFIELD2_2D(U,IDX,i,n1,n2)* MYNEWLINE YMAGFIELD2_2D(U,IDX,i,n1,n2))
#define INVISCIDFLUX4_XDIR2_2D(U,IDX,i,n1,n2,u,v,w,p,q) (ZMOMENTUM2_2D(U,IDX,i,n1,n2)*u-MYNEWLINE XMAGFIELD2_2D(U,IDX,i,n1,n2)* MYNEWLINE ZMAGFIELD2_2D(U,IDX,i,n1,n2))
#define INVISCIDFLUX5_XDIR2_2D(U,IDX,i,n1,n2,u,v,w,p,q)  RCONST(0.0)
#define INVISCIDFLUX6_XDIR2_2D(U,IDX,i,n1,n2,u,v,w,p,q) (YMAGFIELD2_2D(U,IDX,i,n1,n2)*u-MYNEWLINE XMAGFIELD2_2D(U,IDX,i,n1,n2)*v)
#define INVISCIDFLUX7_XDIR2_2D(U,IDX,i,n1,n2,u,v,w,p,q) (ZMAGFIELD2_2D(U,IDX,i,n1,n2)*u-MYNEWLINE XMAGFIELD2_2D(U,IDX,i,n1,n2)*w)
#define INVISCIDFLUX8_XDIR2_2D(U,IDX,i,n1,n2,u,v,w,p,q) (TOTALENERGY2_2D(U,IDX,i,n1,n2)*u+p*u-MYNEWLINE XMAGFIELD2_2D(U,IDX,i,n1,n2)*q)

#define INVISCIDFLUX1_XDIR3_2D(U,IDX,i,j,n1,n2,n3,u,v,w,p,q)  XMOMENTUM3_2D(U,IDX,i,j,n1,n2,n3)
#define INVISCIDFLUX2_XDIR3_2D(U,IDX,i,j,n1,n2,n3,u,v,w,p,q) (XMOMENTUM3_2D(U,IDX,i,j,n1,n2,n3)*u+p-MYNEWLINE POW(XMAGFIELD3_2D(U,IDX,i,j,n1,n2,n3),2))
#define INVISCIDFLUX3_XDIR3_2D(U,IDX,i,j,n1,n2,n3,u,v,w,p,q) (YMOMENTUM3_2D(U,IDX,i,j,n1,n2,n3)*u-MYNEWLINE XMAGFIELD3_2D(U,IDX,i,j,n1,n2,n3)* MYNEWLINE YMAGFIELD3_2D(U,IDX,i,j,n1,n2,n3))
#define INVISCIDFLUX4_XDIR3_2D(U,IDX,i,j,n1,n2,n3,u,v,w,p,q) (ZMOMENTUM3_2D(U,IDX,i,j,n1,n2,n3)*u-MYNEWLINE XMAGFIELD3_2D(U,IDX,i,j,n1,n2,n3)* MYNEWLINE ZMAGFIELD3_2D(U,IDX,i,j,n1,n2,n3))
#define INVISCIDFLUX5_XDIR3_2D(U,IDX,i,j,n1,n2,n3,u,v,w,p,q)  RCONST(0.0)
#define INVISCIDFLUX6_XDIR3_2D(U,IDX,i,j,n1,n2,n3,u,v,w,p,q) (YMAGFIELD3_2D(U,IDX,i,j,n1,n2,n3)*u-MYNEWLINE XMAGFIELD3_2D(U,IDX,i,j,n1,n2,n3)*v)
#define INVISCIDFLUX7_XDIR3_2D(U,IDX,i,j,n1,n2,n3,u,v,w,p,q) (ZMAGFIELD3_2D(U,IDX,i,j,n1,n2,n3)*u-MYNEWLINE XMAGFIELD3_2D(U,IDX,i,j,n1,n2,n3)*w)
#define INVISCIDFLUX8_XDIR3_2D(U,IDX,i,j,n1,n2,n3,u,v,w,p,q) (TOTALENERGY3_2D(U,IDX,i,j,n1,n2,n3)*u+p*u-MYNEWLINE XMAGFIELD3_2D(U,IDX,i,j,n1,n2,n3)*q)
...
#define INVISCIDFLUX2_YDIR1_2D(U,IDX,u,v,w,p,q) (XMOMENTUM1_2D(U,IDX)*v-MYNEWLINE YMAGFIELD1_2D(U,IDX)* MYNEWLINE XMAGFIELD1_2D(U,IDX))
#define INVISCIDFLUX3_YDIR1_2D(U,IDX,u,v,w,p,q) (YMOMENTUM1_2D(U,IDX)*v+p-MYNEWLINE POW(YMAGFIELD1_2D(U,IDX),2))
#define INVISCIDFLUX4_YDIR1_2D(U,IDX,u,v,w,p,q) (ZMOMENTUM1_2D(U,IDX)*v-MYNEWLINE YMAGFIELD1_2D(U,IDX)* MYNEWLINE ZMAGFIELD1_2D(U,IDX))
#define INVISCIDFLUX5_YDIR1_2D(U,IDX,u,v,w,p,q) (XMAGFIELD1_2D(U,IDX)*v-MYNEWLINE YMAGFIELD1_2D(U,IDX)*u)
#define INVISCIDFLUX6_YDIR1_2D(U,IDX,u,v,w,p,q)  RCONST(0.0)
#define INVISCIDFLUX7_YDIR1_2D(U,IDX,u,v,w,p,q) (ZMAGFIELD1_2D(U,IDX)*v-MYNEWLINE YMAGFIELD1_2D(U,IDX)*w)
#define INVISCIDFLUX8_YDIR1_2D(U,IDX,u,v,w,p,q) (TOTALENERGY1_2D(U,IDX)*v+p*v-MYNEWLINE YMAGFIELD1_2D(U,IDX)*q)

#define INVISCIDFLUX1_YDIR2_2D(U,IDX,i,n1,n2,u,v,w,p,q)  YMOMENTUM2_2D(U,IDX,i,n1,n2)
#define INVISCIDFLUX2_YDIR2_2D(U,IDX,i,n1,n2,u,v,w,p,q) (XMOMENTUM2_2D(U,IDX,i,n1,n2)*v-MYNEWLINE YMAGFIELD2_2D(U,IDX,i,n1,n2)* MYNEWLINE XMAGFIELD2_2D(U,IDX,i,n1,n2))
#define INVISCIDFLUX3_YDIR2_2D(U,IDX,i,n1,n2,u,v,w,p,q) (YMOMENTUM2_2D(U,IDX,i,n1,n2)*v+p-MYNEWLINE POW(YMAGFIELD2_2D(U,IDX,i,n1,n2),2))
#define INVISCIDFLUX4_YDIR2_2D(U,IDX,i,n1,n2,u,v,w,p,q) (ZMOMENTUM2_2D(U,IDX,i,n1,n2)*v-MYNEWLINE YMAGFIELD2_2D(U,IDX,i,n1,n2)* MYNEWLINE ZMAGFIELD2_2D(U,IDX,i,n1,n2))
#define INVISCIDFLUX5_YDIR2_2D(U,IDX,i,n1,n2,u,v,w,p,q) (XMAGFIELD2_2D(U,IDX,i,n1,n2)*v-MYNEWLINE YMAGFIELD2_2D(U,IDX,i,n1,n2)*u)
#define INVISCIDFLUX6_YDIR2_2D(U,IDX,i,n1,n2,u,v,w,p,q)  RCONST(0.0)
#define INVISCIDFLUX7_YDIR2_2D(U,IDX,i,n1,n2,u,v,w,p,q) (ZMAGFIELD2_2D(U,IDX,i,n1,n2)*v-MYNEWLINE YMAGFIELD2_2D(U,IDX,i,n1,n2)*w)
#define INVISCIDFLUX8_YDIR2_2D(U,IDX,i,n1,n2,u,v,w,p,q) (TOTALENERGY2_2D(U,IDX,i,n1,n2)*v+p*v-MYNEWLINE YMAGFIELD2_2D(U,IDX,i,n1,n2)*q)

#define INVISCIDFLUX1_YDIR3_2D(U,IDX,i,j,n1,n2,n3,u,v,w,p,q)  YMOMENTUM3_2D(U,IDX,i,j,n1,n2,n3)
#define INVISCIDFLUX2_YDIR3_2D(U,IDX,i,j,n1,n2,n3,u,v,w,p,q) (XMOMENTUM3_2D(U,IDX,i,j,n1,n2,n3)*v-MYNEWLINE YMAGFIELD3_2D(U,IDX,i,j,n1,n2,n3)* MYNEWLINE XMAGFIELD3_2D(U,IDX,i,j,n1,n2,n3))
#define INVISCIDFLUX3_YDIR3_2D(U,IDX,i,j,n1,n2,n3,u,v,w,p,q) (YMOMENTUM3_2D(U,IDX,i,j,n1,n2,n3)*v+p-MYNEWLINE POW(YMAGFIELD3_2D(U,IDX,i,j,n1,n2,n3),2))
#define INVISCIDFLUX4_YDIR3_2D(U,IDX,i,j,n1,n2,n3,u,v,w,p,q) (ZMOMENTUM3_2D(U,IDX,i,j,n1,n2,n3)*v-MYNEWLINE YMAGFIELD3_2D(U,IDX,i,j,n1,n2,n3)* MYNEWLINE ZMAGFIELD3_2D(U,IDX,i,j,n1,n2,n3))
#define INVISCIDFLUX5_YDIR3_2D(U,IDX,i,j,n1,n2,n3,u,v,w,p,q) (XMAGFIELD3_2D(U,IDX,i,j,n1,n2,n3)*v-MYNEWLINE YMAGFIELD3_2D(U,IDX,i,j,n1,n2,n3)*u)
#define INVISCIDFLUX6_YDIR3_2D(U,IDX,i,j,n1,n2,n3,u,v,w,p,q)  RCONST(0.0)
#define INVISCIDFLUX7_YDIR3_2D(U,IDX,i,j,n1,n2,n3,u,v,w,p,q) (ZMAGFIELD3_2D(U,IDX,i,j,n1,n2,n3)*v-MYNEWLINE YMAGFIELD3_2D(U,IDX,i,j,n1,n2,n3)*w)
#define INVISCIDFLUX8_YDIR3_2D(U,IDX,i,j,n1,n2,n3,u,v,w,p,q) (TOTALENERGY3_2D(U,IDX,i,j,n1,n2,n3)*v+p*v-MYNEWLINE YMAGFIELD3_2D(U,IDX,i,j,n1,n2,n3)*q)
...
#define INVISCIDFLUX2_ZDIR1_3D(U,IDX,u,v,w,p,q) (XMOMENTUM1_3D(U,IDX)*w-MYNEWLINE ZMAGFIELD1_3D(U,IDX)* MYNEWLINE XMAGFIELD1_3D(U,IDX))
#define INVISCIDFLUX3_ZDIR1_3D(U,IDX,u,v,w,p,q) (YMOMENTUM1_3D(U,IDX)*w-MYNEWLINE ZMAGFIELD1_3D(U,IDX)* MYNEWLINE YMAGFIELD1_3D(U,IDX))
#define INVISCIDFLUX4_ZDIR1_3D(U,IDX,u,v,w,p,q) (ZMOMENTUM1_3D(U,IDX)*w+p-MYNEWLINE POW(ZMAGFIELD1_3D(U,IDX),2))
#define INVISCIDFLUX5_ZDIR1_3D(U,IDX,u,v,w,p,q) (XMAGFIELD1_3D(U,IDX)*w-MYNEWLINE ZMAGFIELD1_3D(U,IDX)*u)
#define INVISCIDFLUX6_ZDIR1_3D(U,IDX,u,v,w,p,q) (YMAGFIELD1_3D(U,IDX)*w-MYNEWLINE ZMAGFIELD1_3D(U,IDX)*v)
#define INVISCIDFLUX7_ZDIR1_3D(U,IDX,u,v,w,p,q)  RCONST(0.0)
#define INVISCIDFLUX8_ZDIR1_3D(U,IDX,u,v,w,p,q) (TOTALENERGY1_3D(U,IDX)*w+p*w-MYNEWLINE ZMAGFIELD1_3D(U,IDX)*q)

#define INVISCIDFLUX1_ZDIR2_3D(U,IDX,i,n1,n2,u,v,w,p,q)  ZMOMENTUM2_3D(U,IDX,i,n1,n2)
#define INVISCIDFLUX2_ZDIR2_3D(U,IDX,i,n1,n2,u,v,w,p,q) (XMOMENTUM2_3D(U,IDX,i,n1,n2)*w-MYNEWLINE ZMAGFIELD2_3D(U,IDX,i,n1,n2)* MYNEWLINE XMAGFIELD2_3D(U,IDX,i,n1,n2))
#define INVISCIDFLUX3_ZDIR2_3D(U,IDX,i,n1,n2,u,v,w,p,q) (YMOMENTUM2_3D(U,IDX,i,n1,n2)*w-MYNEWLINE ZMAGFIELD2_3D(U,IDX,i,n1,n2)* MYNEWLINE YMAGFIELD2_3D(U,IDX,i,n1,n2))
#define INVISCIDFLUX4_ZDIR2_3D(U,IDX,i,n1,n2,u,v,w,p,q) (ZMOMENTUM2_3D(U,IDX,i,n1,n2)*w+p-MYNEWLINE POW(ZMAGFIELD2_3D(U,IDX,i,n1,n2),2))
#define INVISCIDFLUX5_ZDIR2_3D(U,IDX,i,n1,n2,u,v,w,p,q) (XMAGFIELD2_3D(U,IDX,i,n1,n2)*w-MYNEWLINE ZMAGFIELD2_3D(U,IDX,i,n1,n2)*u)
#define INVISCIDFLUX6_ZDIR2_3D(U,IDX,i,n1,n2,u,v,w,p,q) (YMAGFIELD2_3D(U,IDX,i,n1,n2)*w-MYNEWLINE ZMAGFIELD2_3D(U,IDX,i,n1,n2)*v)
#define INVISCIDFLUX7_ZDIR2_3D(U,IDX,i,n1,n2,u,v,w,p,q)  RCONST(0.0)
#define INVISCIDFLUX8_ZDIR2_3D(U,IDX,i,n1,n2,u,v,w,p,q) (TOTALENERGY2_3D(U,IDX,i,n1,n2)*w+p*w-MYNEWLINE ZMAGFIELD2_3D(U,IDX,i,n1,n2)*q)

#define INVISCIDFLUX1_ZDIR3_3D(U,IDX,i,j,n1,n2,n3,u,v,w,p,q)  ZMOMENTUM3_3D(U,IDX,i,j,n1,n2,n3)
#define INVISCIDFLUX2_ZDIR3_3D(U,IDX,i,j,n1,n2,n3,u,v,w,p,q) (XMOMENTUM3_3D(U,IDX,i,j,n1,n2,n3)*w-MYNEWLINE ZMAGFIELD3_3D(U,IDX,i,j,n1,n2,n3)* MYNEWLINE XMAGFIELD3_3D(U,IDX,i,j,n1,n2,n3))
#define INVISCIDFLUX3_ZDIR3_3D(U,IDX,i,j,n1,n2,n3,u,v,w,p,q) (YMOMENTUM3_3D(U,IDX,i,j,n1,n2,n3)*w-MYNEWLINE ZMAGFIELD3_3D(U,IDX,i,j,n1,n2,n3)* MYNEWLINE YMAGFIELD3_3D(U,IDX,i,j,n1,n2,n3))
#define INVISCIDFLUX4_ZDIR3_3D(U,IDX,i,j,n1,n2,n3,u,v,w,p,q) (ZMOMENTUM3_3D(U,IDX,i,j,n1,n2,n3)*w+p-MYNEWLINE POW(ZMAGFIELD3_3D(U,IDX,i,j,n1,n2,n3),2))
#define INVISCIDFLUX5_ZDIR3_3D(U,IDX,i,j,n1,n2,n3,u,v,w,p,q) (XMAGFIELD3_3D(U,IDX,i,j,n1,n2,n3)*w-MYNEWLINE ZMAGFIELD3_3D(U,IDX,i,j,n1,n2,n3)*u)
#define INVISCIDFLUX6_ZDIR3_3D(U,IDX,i,j,n1,n2,n3,u,v,w,p,q) (YMAGFIELD3_3D(U,IDX,i,j,n1,n2,n3)*w-MYNEWLINE ZMAGFIELD3_3D(U,IDX,i,j,n1,n2,n3)*v)
#define INVISCIDFLUX7_ZDIR3_3D(U,IDX,i,j,n1,n2,n3,u,v,w,p,q)  RCONST(0.0)
#define INVISCIDFLUX8_ZDIR3_3D(U,IDX,i,j,n1,n2,n3,u,v,w,p,q) (TOTALENERGY3_3D(U,IDX,i,j,n1,n2,n3)*w+p*w-MYNEWLINE ZMAGFIELD3_3D(U,IDX,i,j,n1,n2,n3)*q)
