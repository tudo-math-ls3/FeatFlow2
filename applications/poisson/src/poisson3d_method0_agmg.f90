!##############################################################################
!# ****************************************************************************
!# <name> poisson3d_method0_agmg </name>
!# ****************************************************************************
!#
!# <purpose>
...
!# poisson2d_method0_agmg.
!# </purpose>
!##############################################################################

module poisson3d_method0_agmg
...
!</subroutine>
    ...
    ! Apply filter chain to matrix and vector
    call filter_applyFilterChainMat(rmatSystem,RfilterChain)
    call filter_applyFilterChainVec(rvecRhs,RfilterChain)

    ! Create a AGMG-solver.
    call linsol_initAGMG (p_rsolverNode)
    
    ! Adjust parameter for symmetric system matrix
    p_rsolverNode%p_rsubnodeAGMG%nrest = 1
