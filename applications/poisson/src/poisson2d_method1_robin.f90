...
!</subroutine>
    ...
    call linf_buildVectorScalar (&
        rlinform,.true.,rrhsBlock%RvectorBlock(1),rcubatureInfo,coeff_RHS_RobinExample)
    ...
    call bilf_buildMatrixScalarBdr2D (rbilinform_boundary, ccubType_boundary, .false.,&
        rmatrixBlock%RmatrixBlock(1,1), coeff_mass_robinBC, rboundaryRegion, rcollection)
    ...
    call linf_buildVectorScalarBdr2d (rlinform_boundary, ccubType_boundary, &
        .false.,rrhsBlock%RvectorBlock(1),coeff_RHS_RobinBC,rboundaryRegion,rcollection)
