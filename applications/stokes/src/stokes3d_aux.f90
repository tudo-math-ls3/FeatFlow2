!##############################################################################
!# ****************************************************************************
!# <name> stokes3d_aux </name>
!# ****************************************************************************
!#
!# <purpose>
!# This module contains some auxiliary routines for the 3D stokes solvers.
!# </purpose>
!##############################################################################
...
!<subroutine>
  ...
  SUBROUTINE st3daux_calcCubeDirichletRegion(rmeshRegion)
...
!<description>
  ...
  ! conditions.
  !
  ! In the 3d stokes examples, we will prescribe Dirichlet boundary conditions
...
!</subroutine>
   ...
   REAL(DP) :: dx
    ...
    CALL storage_new('st3daux_calcCubeRegion', 'p_IfaceIdx', iNAT, &
