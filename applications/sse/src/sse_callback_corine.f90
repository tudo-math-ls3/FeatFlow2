...
!#
!# 2.) sse_postprocessing_Corine
!#     -> Post-processes the solution
!#
!# 3.) sse_outputTable_Corine
...
module sse_callback_corine
  ...
  public :: sse_postprocessing_Corine
  public :: sse_outputTable_Corine
...
!<subroutine>
  ...
  subroutine sse_postprocessing_Corine(rproblem,sucdDir,sucdFile,cucdType,rtable)
...
!</subroutine>
  ...
  end subroutine sse_postprocessing_Corine

  ! ***************************************************************************

!<subroutine>

  subroutine sse_outputTable_Corine(rproblem,rtable)
...
!</subroutine>
    ...
    case default
      call output_line("Invalid type of problem.", &
          OU_CLASS_ERROR,OU_MODE_STD,"sse_outputTable_Corine")
      call sys_halt()
    end select

  end subroutine sse_outputTable_Corine
