...
* hand side vector on triangular meshes. They accept the
* extended calling convention, thus passing a user-defined parameter
* block to callback routines.
*
* All routines base on XAV0/VA0-routines of the FEAT library.
************************************************************************
...
************************************************************************
      ...
      SUBROUTINE XVA0X(TRIA, IPARAM, DPARAM,IGEOM,DGEOM,
     *                 NBLOC,LB,NEQ,ICLEAR,ELE,
...
C     Call the RHS vector generation routine
      ...
      CALL VA0X(TRIA,IPARAM,DPARAM,IGEOM,DGEOM,
...
* one matrix-block, thus the NBLOC-parameter of the original XVA0-
...
************************************************************************
      ...
      SUBROUTINE VA0X(TRIA,IPARAM,DPARAM,IGEOM,DGEOM,
...
C local variables      
      ...
      DOUBLE PRECISION DJF(2,2),XI1,XI2,XI3,XX,YY,AUX,OM
