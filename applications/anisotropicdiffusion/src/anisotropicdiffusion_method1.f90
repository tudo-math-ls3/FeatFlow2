...
!</subroutine>
    ...
    case (1)
      ...
      call jstab_calcUEOJumpStabilisation (&
          rmatrix,dgamma,dgamma,1.0_DP,1.0_DP,CUB_G3_1D,1.0_DP)
    case DEFAULT    
    ...
    select case (ieltype)
    case (-1,1,11)
      call ucd_startGMV (rexport,UCD_FLAG_STANDARD,rtriangulation,trim(sucddir)//'/u1.gmv')
      call ucd_addVariableVertexBased (rexport,'sol',UCD_VAR_STANDARD, p_Ddata)
    case (2)
      call ucd_startGMV (rexport,UCD_FLAG_ONCEREFINED,rtriangulation,trim(sucddir)//'/u1.gmv')
    ...
    case (-30)
      !CALL ucd_startGMV (rexport,UCD_FLAG_STANDARD,rtriangulation,trim(sucddir)//'/u1.gmv')
      call ucd_startGMV (rexport,UCD_FLAG_BULBQUADRATIC,rtriangulation,trim(sucddir)//'/u1.gmv')
      ...
      call ad1_discretiseBC(isolution,rdiscretisationPostProc,rcollection,&
          rdiscreteBCPostProc)
...
!<subroutine>
  ...
  subroutine ad1_discretiseBC (isolution,rdiscretisation,rcollection,rdiscreteBC)
