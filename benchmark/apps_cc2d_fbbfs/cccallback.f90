...
!<subroutine>
  ...
  !</subroutine>
    ...
    ! local variables
    real(DP) :: ddistance, dx1, dy1, dx2, dy2, dradius, dx, dy
    ...
    ! http://www.mathematik.uni-dortmund.de/~featflow/album/catalog/bfs_high_2d/data_comp.html
    ...
    do idx = 1,Revaluation(1)%nvalues
      ...
      ! Point inside?
      if ((dx .ge. dx1) .and. (dx .le. dx2) .and. &
          (dy .ge. dy1) .and. (dy .le. dy2)) then
