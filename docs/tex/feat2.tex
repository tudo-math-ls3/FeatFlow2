...
\makeindex{types}
\makeindex{variables}
\makeindex{subroutines}
\makeindex{functions}
\makeindex{interfaces}
...
\printindex{modules}{Index of Modules}
\printindex{constants}{Index of Constants}
\printindex{types}{Index of Derived Types}
\printindex{variables}{Index of Variables}
\printindex{subroutines}{Index of Subroutines}
\printindex{functions}{Index of Functions}
\printindex{interfaces}{Index of Interfaces}
